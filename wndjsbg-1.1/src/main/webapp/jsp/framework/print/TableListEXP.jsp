...
String dao = Pub.val(request,"dao");
String jsonStr = Pub.val(request,"jsonStr");
%>
...
<body onload="doInit()">
   ...
   <form method="post" action="${pageContext.request.contextPath }/servlet/TableExp" id="loginForm" >
       ...
       <button id="morePageExcel" class="btn btn-primary"  type="button">导出所有页excel</button>
        ...
        <textarea type="text" id="tabHtml" style="display:none;" name="ExpTabListResultValue"></textarea>
        <textarea type="text" id="querycondition" style="display:none" name="ExpTabListQueryCondition"></textarea>
        <textarea type="text" id="tabThead" style="display:none" name="ExpTabListThead"></textarea>
        <textarea type="text" id="fieldname" style="display:none" name="ExpTabListFieldNames"></textarea>        
        <textarea type="text" id="actionName" style="display:none" name="ExpActionName"></textarea>        
        <textarea type="text" id="templateName" style="display:none" name="templateName"><%=templateName%></textarea>    
        <textarea type="text" id="fieldnames" style="display:none" name="fieldnames"><%=fieldnames%></textarea>           
        <textarea type="text" id="startXY" style="display:none" name="startXY"><%=startXY%></textarea>        
        <textarea type="text" id="dao" style="display:none" name="dao"><%=dao%></textarea>        
        <textarea type="text" id="jsonStr" style="display:none" name="jsonStr"><%=jsonStr%></textarea>        

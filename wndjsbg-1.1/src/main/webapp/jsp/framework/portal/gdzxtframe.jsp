...
<%--办公系统传递过来的参数 --%>
<%
	String projectid = request.getParameter("gdzxt_projectid");
%>
...
<script type="text/javascript">
    ...
    {  
    	...
    	if("#"!=menuLocation){
    		if(target=="pagearea"){
    			document.getElementById("menuiframe").src = "${pageContext.request.contextPath}/"+menuLocation+"?projectid="+<%=projectid %>;
...
<input type="hidden" id="GDZXT_XM_ID" value="${GONGCHENG_UID}" >

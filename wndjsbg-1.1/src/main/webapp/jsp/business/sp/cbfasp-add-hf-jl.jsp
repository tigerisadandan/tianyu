					...
					<div class="B-small-from-table-autoConcise">
						...
						<form method="post" id="gcjsxmzjfbhtbabForm">
							...
							<table style="width: 700px; height: 350px;" border="1" align="center">
								...
								<tr>
									<td width="20%"  align="center">监理师</td>
									<td width="30%" >
										<input name="JLS" maxlength="20" type="text" id="JLS" fieldname="JLS" style="width: 93%"  readonly placeholder="必填" check-type="required"/>
									</td>
									<td width="20" align="center">资质证书编号</td>
									<td width="30%" >
										<input name="JL_ZSBH" type="text" maxlength="20" id="JL_ZSBH" fieldname="JL_ZSBH" style="width: 93%" readonly placeholder="必填" check-type="required"/>
									</td>
								</tr>
								<tr>
									<td colspan="4">
									备注:<input name="BZ2" type="text" maxlength="20" id="BZ2" fieldname="BZ2" style="width: 93%" />
									</td>
								</tr>

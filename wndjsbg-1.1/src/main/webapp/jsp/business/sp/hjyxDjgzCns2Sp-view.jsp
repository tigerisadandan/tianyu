...
<title>建设项目环境影响评价报告表（书）--审批—-区域开发几其他类—-详细信息</title>
<%
...
var controllername= "${pageContext.request.contextPath }/sp/buSpywHjyxdjgzcns2SpController/";
...
<div class="container-fluid">
   ...
   <div style="height:5px;"></div>
	<div class="B-small-from-table-autoConcise">
     ...
     <table width="750" height="1000" border="1" align="center">
    ...
    <tr>
      <td height="25" colspan="6" align="left"><strong>（一）项目基本信息</strong></td>
    </tr>
    <tr>
  ...
  <tr>
    <td height="194" colspan="7" align="left"><p ><strong>本人郑重声明： </strong></p>

...
<title>建设项目环境影响评价报告表（书）--审批—-饮食娱乐服务类——详细信息</title>
<%
...
var controllername= "${pageContext.request.contextPath }/sp/buSpywHjyxdjgzcns3SpController/";
...
<div class="container-fluid">
  ...
  <tr>
    <td height="40" colspan="7" align="left"><strong>（二）项目拟选建设地址周围300米范围内主要敏感目标（居民点、河流等）分布状况示意图。</strong></td>
  </tr>
  <tr>

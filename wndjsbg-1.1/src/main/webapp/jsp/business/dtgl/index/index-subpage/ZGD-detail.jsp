         ...
         <tr>
			<th width="8%" class="right-border bottom-border text-right">项目进度</th>
       		<td class="bottom-border right-border" width="15%" colspan="3">
         		...
         		<select  id="XXJD2"  name="XXJD2" fieldname="XXJD2" onchange="selectFun2(this.value);"><option value="" disabled="disabled">请选择</option></select>
         		<select  id="XXJD3"  name="XXJD3" fieldname="XXJD3" style="display: none;" disabled="disabled"><option value="">请选择</option></select>

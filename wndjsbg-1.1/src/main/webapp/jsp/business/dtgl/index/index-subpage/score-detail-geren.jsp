...
$(function() {
	...
	$("#btnSave").click(function() {
		if($("#kscoreForm").validationButton()){
		  ...
		  //调用ajax插入
    		defaultJson.doUpdateJson(controllername + "?updatePersonSh", data1);
...
function seeXy(){
	...
	window.open("geren-xypf.jsp?clDx="+clDx+"&clUid="+clUid+"&clType="+clType);
}
         ...
         <tr>
			...
			<th width="8%" class="right-border bottom-border text-right">姓名</th>
       		<td class="bottom-border right-border" width="15%">
         		<input readonly="readonly"  type="text" fieldname="CHULI_DUIXIANG_SV"  />
         	</td>
         	<th width="8%" class="right-border bottom-border text-right">当前分数</th>
       		<td class="bottom-border right-border" width="15%">
       			<input type="text" readonly="readonly"  fieldname="KOU_JS">

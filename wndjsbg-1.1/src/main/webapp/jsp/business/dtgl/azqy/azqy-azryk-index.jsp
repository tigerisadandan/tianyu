...
var controllername= "${pageContext.request.contextPath }/jxsb/azPersonController";
...
/**	$("#btnExpExcel").click(function() {
    ...
    $("#PERSON_NAME").val("");
    	document.getElementById("GONGZHONG").options[0].selected=true;
        $("#btnQuery").click();  
    });
...
function rowView(obj){
	...
	$("#resultXML").val(data);
	if(<%=qyid %>==null){
	$(window).manhuaDialog({"title":"建设单位>详细信息","type":"text","content":"${pageContext.request.contextPath }/jsp/business/dtgl/azqy/az-ryglk-add.jsp?type=detail","modal":"2"});
	}else{
	$(window).manhuaDialog({"title":"建设单位>详细信息","type":"text","content":"${pageContext.request.contextPath }/jsp/business/dtgl/azqy/az-ryglk-add.jsp?type=viewQy","modal":"2"});
	}
}
				...
				<table class="B-table" width="100%">
					...
					<TR style="display: none;">
						...
						<TD class="right-border bottom-border">
							...
							<% if(qyid!=null) { %>
							<input type="text" id="AZ_COMPANY_UID" value="<%=qyid %>" name="AZ_COMPANY_UID" fieldname="AZ_COMPANY_UID" operation="=" >
							<% } %>
						</TD>
					</TR>
					<!--可以再此处加入hidden域作为过滤条件 -->
					<tr>
					<% if(qyid==null) { %>
						<th width="4%" class="right-border bottom-border text-right">安装单位</th>
						...
						<th width="3%" class="right-border bottom-border text-right">工种</th>
						<td class="right-border bottom-border" width="20%">
						
							<select class="span12"  id="GONGZHONG" fieldname="GONGZHONG" operation="=" kind="dic" src="GONGZHONG" name = "GONGZHONG" >
						</td>	
	            ...
	            <table width="100%" class="table-hover table-activeTd B-table" id="DT1" type="single"  pageNum="18">
	                <thead>
	                	<tr>
							...
							<th fieldname="SHENFENZHENG" colindex=2 tdalign="center" maxlength="30" >&nbsp;身份证&nbsp;</th>
							<th fieldname=COMPANY_NAME colindex=3 tdalign="center" maxlength="30" >&nbsp;安装单位&nbsp;</th>
							<th fieldname=GONGZHONG colindex=3 tdalign="center" maxlength="30" >&nbsp;工种&nbsp;</th>
							
							<th fieldname="SGZH" colindex=20 tdalign="center" >&nbsp;上岗证号&nbsp;</th>
							<th fieldname="SGZ_YOUXIAO_DATE" colindex=20 tdalign="center" >&nbsp;上岗证有效日期&nbsp;</th>
							<th id="shsjid" fieldname="SHENHE_DATE" colindex=13 tdalign="center" >&nbsp;审核日期&nbsp;</th>
							<th id="tijiao"  fieldname="CREATED_DATE" colindex=14 tdalign="center" >&nbsp;申请时间&nbsp;</th>						
	                	</tr>
	                </thead>
	              	<tbody></tbody>
	           </table>

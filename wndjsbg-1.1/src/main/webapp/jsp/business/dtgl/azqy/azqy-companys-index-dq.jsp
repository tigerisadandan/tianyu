...
$(function() {
	...
	$("#btnQuery").click(function() {
		...
		//调用ajax插入
		defaultJson.doQueryJsonList(controllername+"?queryDq",data,DT1);
	//	getCount();
...
function rowSh(obj){
	...
	$("#resultXML").val(data);
	$(window).manhuaDialog({"title":"建设单位>详细信息","type":"text","content":"${pageContext.request.contextPath }/jsp/business/dtgl/azqy/az-company-add-dq.jsp?type=update","modal":"2"});
}

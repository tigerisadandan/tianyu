...
$(function() {
	...
	$("#btnQuery").click(function() {
		...
		//调用ajax插入
		defaultJson.doQueryJsonList(controllername+"?query&start="+$("#BY_DATE_START").val()+"&end="+$("#BY_DATE_END").val(),data,DT1);
	//	getCount();
			...
			<form method="post" id="queryForm">
				<table class="B-table" width="100%">
					...
					<tr>
						...
						<th width="5%" class="right-border bottom-border text-right">维保单位</th>
						<td class="right-border bottom-border" width="15%">
						...
						<th width="5%" class="right-border bottom-border text-right">保养时间</th>
						<td class="right-border bottom-border" width="30%">
							<input class="Wdate" type="text" onclick="WdatePicker()" style="width:40%" fieldformat="YYYY-MM-DD" id="BY_DATE_START" value="" >~
							<input  class="Wdate" type="text" onclick="WdatePicker()" style="width:40%" fieldformat="YYYY-MM-DD" id="BY_DATE_END" value="">
						</td>
						</td>
	            ...
	            <table width="100%" class="table-hover table-activeTd B-table" id="DT1" type="single"  pageNum="18">
	                <thead>
	                	<tr>
	                		...
	                		<th fieldname="JXSB_BYWX_UID" colindex=0 tdalign="center"  CustomFunction="caozuoFun" >&nbsp;&nbsp;</th>
							<th fieldname="GC_NAME" colindex=2 tdalign="center" maxlength="30" >&nbsp;项目名称&nbsp;</th>
							<th fieldname="COMPANY_NAME" colindex=2 tdalign="center" maxlength="30" >&nbsp;维保单位&nbsp;</th>
							<th fieldname=JCBG_BH colindex=3 tdalign="center" maxlength="30" >&nbsp;检测报告编号&nbsp;</th>
							<th fieldname=BY_DATE colindex=3 tdalign="center" maxlength="30" >&nbsp;保养日期&nbsp;</th>						
	                	</tr>
	                </thead>
	              	<tbody></tbody>
	           </table>

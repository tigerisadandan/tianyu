...
function rowSh(obj){
	...
	$("#resultXML").val(data);
	$(window).manhuaDialog({"title":"建设单位>详细信息","type":"text","content":"${pageContext.request.contextPath }/jsp/business/dtgl/azqy/az-company-add-yqsq.jsp?type=update","modal":"2"});
}
				...
				<table class="B-table" width="100%">
					...
					<TR style="display: none;">
						...
						<TD class="right-border bottom-border">
							...
							<INPUT type="text" class="span12" id="YQ_STATUS" fieldname="YQ_STATUS" value="0"  operation="="/>

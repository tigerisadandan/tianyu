...
function rowSh(obj){
	...
	$("#resultXML").val(data);
	$(window).manhuaDialog({"title":"机械设备降级使用记录","type":"text","content":"${pageContext.request.contextPath }/jsp/business/dtgl/azqy/azqy-jxsb-jjjl-index-view.jsp?type=update","modal":"2"});
}
			...
			<form method="post" id="queryForm">
				<table class="B-table" width="100%">
					...
					<tr>
						...
						<th width="5%" class="right-border bottom-border text-right">降级后设备型号</th>
						<td class="right-border bottom-border" width="15%">
							<input class="span12" type="text" onkeydown="enterSumbit()" id="NEW_SB_XH" name="NEW_SB_XH" fieldname="NEW_SB_XH" operation="like" >
						</td>
	            ...
	            <table width="100%" class="table-hover table-activeTd B-table" id="DT1" type="single"  pageNum="18">
	                <thead>
	                	<tr>
	                		...
	                		<th fieldname="JXSB_JJSY_UID" colindex=0 tdalign="center"  CustomFunction="caozuoFun" >&nbsp;&nbsp;</th>
							<th fieldname="GC_NAME" colindex=2 tdalign="center" maxlength="30" >&nbsp;项目名称&nbsp;</th>
							<th fieldname="SB_XH" colindex=2 tdalign="center" maxlength="30" >&nbsp;降级前设备型号&nbsp;</th>
							<th fieldname=NEW_SB_XH colindex=3 tdalign="center" maxlength="30" >&nbsp;降级后设备型号&nbsp;</th>
							<th fieldname=REPORT_CODE colindex=3 tdalign="center" maxlength="30" >&nbsp;结构检验报告编号&nbsp;</th>
							<th fieldname=CRDATE colindex=3 tdalign="center" maxlength="30" >&nbsp;创建日期&nbsp;</th>
	                	</tr>
	                </thead>
	              	<tbody></tbody>
	           </table>

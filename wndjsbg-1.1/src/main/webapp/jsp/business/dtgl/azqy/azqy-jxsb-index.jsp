		...
		// alert(status);
		 if(status=='30'){
			// alert(status);
				...
				$("#shsjid").hide();
				$("#tijiao").show();	
				$("#txtFilter_sj").attr("fieldname","CREATED_DATE");
			}else{
				$("#shrid").show();			
				$("#shsjid").show();
				$("#tijiao").hide();	
...
function rowView(obj){
	...
	$("#resultXML").val(data);
	$(window).manhuaDialog({"title":"安装企业>设备信息","type":"text","content":"${pageContext.request.contextPath }/jsp/business/dtgl/azqy/az-jxsb-add.jsp?type=detail","modal":"2"});
}
...
function rowSh(obj){
	...
	$("#resultXML").val(data);
	$(window).manhuaDialog({"title":"安装企业>设备审核","type":"text","content":"${pageContext.request.contextPath }/jsp/business/dtgl/azqy/az-jxsb-add.jsp?type=update","modal":"2"});
}
			...
			<form method="post" id="queryForm">
				<table class="B-table" width="100%">
					...
					<tr>
						...
						<th width="3%" class="right-border bottom-border text-right">产权单位</th>
						<td class="right-border bottom-border" width="17%">
							<input class="span12" type="text" onkeydown="enterSumbit()" id="CQDW" name="CQDW" fieldname="CQDW" operation="like" >
						</td>	
	            ...
	            <table width="100%" class="table-hover table-activeTd B-table" id="DT1" type="single"  pageNum="18">
	                <thead>
	                	<tr>
							...
							<th fieldname="CQBH" colindex=2 tdalign="center" maxlength="30">&nbsp;产权编号&nbsp;</th>
							<th fieldname="JXSB_TYPE_UID_SV" colindex=2 tdalign="center" maxlength="30" >&nbsp;设备类型&nbsp;</th>
							<th fieldname=CQDW colindex=3 tdalign="center" maxlength="30" >&nbsp;产权单位&nbsp;</th>
							<th fieldname=SB_XH colindex=3 tdalign="center" maxlength="30" >&nbsp;设备型号&nbsp;</th>
							<th fieldname="ZZDW" colindex=20 tdalign="center" >&nbsp;制造厂家&nbsp;</th>
							<th fieldname="YOUXIAO_DATE" colindex=20 tdalign="center" >&nbsp;设备有效期&nbsp;</th>				
	                	</tr>
	                </thead>
	              	<tbody></tbody>
	           </table>

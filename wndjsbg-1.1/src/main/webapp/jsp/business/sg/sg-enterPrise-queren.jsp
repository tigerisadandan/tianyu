...
$(function() {
	...
	$("#btnSave").click(function() {
		...
		{
			if(confirm("您已确认项目和奖项信息吗?")){
		    	$.ajax({
		    		url : controllername+"updateQy?uid="+$("#ID").val(),
		    		data : {},
		    		cache : false,
		    		async :	false,
		    		dataType : "text",  
...
function querenXX(){
	...
	$("#QUEREN_STATUS").val("10");
	$("#QUEREN_REN").val("<%=user.getIdCard()%>");
	$("#QUEREN_DATE").val(getDate());
}
function getDate(){
		...
		<div class="container-fluid">
			<p class="text-right tabsRightButtonP">
				<span class="pull-right">
					...
					<button id="btnSave" class="btn" type="button" style="font-family:SimYou,Microsoft YaHei;font-weight:bold;">确认</button>
				</span>
			</p>
			<ul class="nav nav-tabs"> 
				<li class=""><a href="#xmsc1" data-toggle="tab" id="tabPage0">施工单位信息</a></li> 
				<li class="active"><a href="#xmsc2" data-toggle="tab" id="tabPage1">相关荣誉</a></li>
			</ul>
			<div class="tab-content"> 
				<!-- 静态信息tab页 -->
				<div class="tab-pane" id="xmsc1" style="height:100%"> 
				<table class="B-table" width="100%" >
					...
					<input type="hidden" id="SG_ENTERPRISE_LIBRARY_FILEUPLOAD" fieldname="SG_ENTERPRISE_LIBRARY_FILEUPLOAD" name = "SG_ENTERPRISE_LIBRARY_FILEUPLOAD"/>
				  	...
				  	<input type="hidden" id="QUEREN_STATUS" fieldname="QUEREN_STATUS" name = "QUEREN_STATUS"/>
				  	<input type="hidden" id="QUEREN_REN" fieldname="QUEREN_REN" name = "QUEREN_REN"/>
				  	<input type="hidden" id="QUEREN_DATE" fieldname="QUEREN_DATE" name = "QUEREN_DATE"/>
			...
			<%--				<input id="ZFJE" class="span12" keep="true" placeholder="必填" check-type="required" check-type="maxlength" maxlength="17" value=0 style="width:70%;text-align:right;" name="ZFJE" fieldname="ZFJE" type="number" />&nbsp;<b>(元)</b>--%>
					...
					<tr id="pwdtr">
						...
						<td  class="right-border bottom-border">
							<input id="PWD" class="span12" style="width:35%" placeholder="必填" check-type="required" check-type="maxlength" maxlength="10" name="PWD" fieldname="PWD" type="password" />
							<font style="color:red;font-size: 16px"><b>*</b></font>
						</td>
					</tr>
					<tr id="pwdtr_re">
						...
						<td  class="right-border bottom-border">
							<input id="PWD1" class="span12" style="width:35%" placeholder="必填" check-type="required" check-type="maxlength" maxlength="10" name="PWD" type="password" />
							<font style="color:red;font-size: 16px"><b>*</b></font>
					...
					<tr>
						<th width="15%" class="right-border bottom-border text-right" >营业执照</th>
					...
					<tr>
						<th class="right-border bottom-border text-right" style="line-height:18px;" >税务登记证</th>
						<td  class="right-border bottom-border" style="padding:0px;">
							<table width="100%">
								<tr>
					...
					<tr>
						<th class="right-border bottom-border text-right" style="line-height:18px;" >开户银行</th>
						<td  class="right-border bottom-border" style="padding:0px;">
							<table width="100%">
								<tr>
					...
					<tr>
						<th class="right-border bottom-border text-right" style="line-height:18px;" >安全生产许可证</th>
						<td  class="right-border bottom-border" style="padding:0px;">
							<table width="100%">
								<tr>
					...
					<tr>
						...
						<td  class="right-border bottom-border">
							<input id="ZHENGSHU_CODE" class="span12" style="width:35%" placeholder="必填" check-type="required" check-type="maxlength" maxlength="36" name="ZHENGSHU_CODE" fieldname="ZHENGSHU_CODE" type="text" />
						</td>
					</tr>
					<tr>
			    ...
			    <div class="tab-pane active" id="xmsc2" style="height:100%">

...
var controllernameJiangx= "${pageContext.request.contextPath }/sgenter/sgECreditCommendRewardController.do";
var controllernameXiangm= "${pageContext.request.contextPath }/sgenter/sgECreditProjectsController.do";
...
function init(){
	...
	if(type=='register'){
		$("#STATUS").val(30);
		$("input:radio[name='WAIDI_Y']")[1].checked = true;
		//="必填" check-type="required"
		//getSequences();
	}
	checkButton();
}
...
<%--	$("#ZHU_DENGJI").val(resultobj.ZHU_DENGJI);--%>
	...
	$("#DAIMA_Z").val(code.substring(0,code.length-1));
	$("#DAIMA_F").val(code.substring(code.length-1));
	checkButton();
}
		...
		<div class="container-fluid">
			<p class="text-right tabsRightButtonP">
				<span class="pull-right">
					<button id="btnClose" class="btn" type="button" style="font-family:SimYou,Microsoft YaHei;font-weight:bold;">关闭</button>
	  				<button id="btnSave" class="btn" type="button" style="font-family:SimYou,Microsoft YaHei;font-weight:bold;">提交注册</button>
				</span>
			</p>
			...
			<div class="tab-content"> 
				...
				<table class="B-table" width="100%" >
			        ...
			        <tr>
			        	<th width="15%" class="right-border bottom-border text-right">组织代码证扫描件</th>
			        	<td class="bottom-border right-border">
							<div>
			        ...
			        <tr>
						<th width="15%" class="right-border bottom-border text-right">施工企业全称</th>
						<td  class="right-border bottom-border">
			...
			<%--				<input id="ZFJE" class="span12" keep="true" placeholder="必填" check-type="required" check-type="maxlength" maxlength="17" value=0 style="width:70%;text-align:right;" name="ZFJE" fieldname="ZFJE" type="number" />&nbsp;<b>(元)</b>--%>
					...
					<tr id="pwdtr">
						<th width="15%" class="right-border bottom-border text-right">密码</th>
						<td  class="right-border bottom-border">
					...
					<tr id="pwdtr_re">
						<th width="15%" class="right-border bottom-border text-right">密码确认</th>
						<td  class="right-border bottom-border">
					...
					<tr>
						...
						<td  class="right-border bottom-border">
							<input id="ZHIZHAO_VALID"   style="width:33.5%;" fieldtype="date" fieldformat="YYYY-MM-DD" name="ZHIZHAO_VALID" fieldname="ZHIZHAO_VALID" check-type="required" class="Wdate" type="text" onClick="WdatePicker()"/>
							<font style="color:red;font-size: 16px"><b>*</b></font>
						</td>
					</tr>
					<tr>
			        	<th width="15%" class="right-border bottom-border text-right">营业执照扫描件</th>
			        	<td  class="bottom-border right-border">
							<div>
					...
					<tr>
						<th width="15%" class="right-border bottom-border text-right">税务登记号</th>
						<td  class="right-border bottom-border">
							<input id="SHUIWU" class="span12" style="width:35%" placeholder="必填" check-type="required" check-type="maxlength" maxlength="36" name="SHUIWU" fieldname="SHUIWU" type="text" />
							<font style="color:red;font-size: 16px"><b>*</b></font>
						</td>
					</tr>
					<tr>
			        	<th width="15%" class="right-border bottom-border text-right">税务登记证描件</th>
			        	<td  class="bottom-border right-border">
							<div>
					...
					<tr>
						...
						<td  class="right-border bottom-border">
							<input id="BANK" class="span12" style="width:35%" placeholder="必填" check-type="required" check-type="maxlength" maxlength="36" name="BANK" fieldname="BANK" type="text" />
							<font style="color:red;font-size: 16px"><b>*</b></font>
						</td>
					</tr>
					<tr>
						<th width="15%" class="right-border bottom-border text-right">开户银行账号</th>
						<td  class="right-border bottom-border">
							<input id="BANK_ACCOUNT" class="span12" style="width:35%" placeholder="必填" check-type="required" check-type="maxlength" maxlength="36" name="BANK_ACCOUNT" fieldname="BANK_ACCOUNT" type="text" />
							<font style="color:red;font-size: 16px"><b>*</b></font>
						</td>
					</tr>
					<tr>
			        	<th width="15%" class="right-border bottom-border text-right">开户许可证扫描件</th>
			        	<td  class="bottom-border right-border">
							<div>
					...
					<tr>
						...
						<td  class="right-border bottom-border">
							<input id="ZHUCE_ZIJIN" value=0 class="span12"  onkeydown="onlyNum()" onkeyup="isMoney(this)"  name="ZHUCE_ZIJIN" fieldname="ZHUCE_ZIJIN" type="text"  min="0" alt="请输入金额，不能输入中文" style="width:35%;text-align:right;" check-type="required"/><b>(万元)</b>
							<font style="color:red;font-size: 16px"><b>*</b></font>
						</td>
					</tr>
					<tr>
						...
						<td  class="right-border bottom-border">
							<input id="ANQUAN_CODE" class="span12"  style="width:35%" placeholder="必填" check-type="required" check-type="maxlength" maxlength="36" name="ANQUAN_CODE" fieldname="ANQUAN_CODE" type="text" />
							<font style="color:red;font-size: 16px"><b>*</b></font>
						</td>
					</tr>
					<tr>
						<th width="15%" class="right-border bottom-border text-right">安全生产许可证有效期</th>
						<td  class="right-border bottom-border">
							<input id="ANQUAN_VALID" style="width:33.5%;"   check-type="required" fieldtype="date" fieldformat="YYYY-MM-DD" name="ANQUAN_VALID" fieldname="ANQUAN_VALID" class="Wdate" type="text" onClick="WdatePicker()" />
							<font style="color:red;font-size: 16px"><b>*</b></font>
						</td>
					</tr>
					<tr>
			        	<th width="15%" class="right-border bottom-border text-right">安全生产许可证扫描件</th>
			        	<td  class="bottom-border right-border">
							<div>
					...
					<tr>
						<th width="15%" class="right-border bottom-border text-right">信用手册编号</th>
						<td  class="right-border bottom-border">
					...
					<tr>
						<th width="15%" class="right-border bottom-border text-right">信用手册有效期</th>
						<td  class="right-border bottom-border">
					...
					<tr>
			        	<th width="15%" class="right-border bottom-border text-right">信用手册扫描件</th>
			        	<td  class="bottom-border right-border">
							<div>
					...
					<tr>
						<th width="15%" class="right-border bottom-border text-right">主项资质</th>
						<td  class="right-border bottom-border">
							<select  id="ZHENGSHU"  class="span12" style="width:35%" name="SG_ZIZHI_UID" fieldname="SG_ZIZHI_UID" onchange="loadZZDJ(this,'zhuxiang',null)" check-type="required"><option value="">请选择</option></select>
							<select  id="ZHU_DENGJI"  class="span12" style="width:25%" name="ZHU_DENGJI" fieldname="ZHU_DENGJI" value="" check-type="required"><option value="">等级</option></select>
							<font style="color:red;font-size: 16px"><b>*</b></font>
						</td>
					</tr>
					<tr>
					...
					<tr>
						<th width="15%" class="right-border bottom-border text-right">获取资质日期</th>
						<td  class="right-border bottom-border">
							<input id="ZIZHI_DATE"   style="width:33.5%;" fieldtype="date" check-type="required" fieldformat="YYYY-MM-DD" name="ZIZHI_DATE" fieldname="ZIZHI_DATE" class="Wdate" type="text" onClick="WdatePicker()" />
							<font style="color:red;font-size: 16px"><b>*</b></font>
						</td>
					</tr>
					<tr>
						<th width="15%" class="right-border bottom-border text-right">资质有效期</th>
						<td  class="right-border bottom-border">
							<input id="VALID_DATE"   style="width:33.5%;" fieldtype="date" check-type="required" fieldformat="YYYY-MM-DD" name="VALID_DATE" fieldname="VALID_DATE" class="Wdate" type="text" onClick="WdatePicker()" />
							<font style="color:red;font-size: 16px"><b>*</b></font>
						</td>
					</tr>
					<tr>
			        	<th width="15%" class="right-border bottom-border text-right">资质证书扫描件</th>
			        	<td  class="bottom-border right-border">
							<div>
					...
					<!-- 增项资质 -->
					<tr>
						<th width="15%" class="right-border bottom-border text-right">增项资质</th>
						<td  class="right-border bottom-border">
							<table class="B-table" width="100%" id="zizhiList">
								...
								<tr id="cloneTR" style="display: none;"><!-- 用来复制 -->
									...
									<td><input id="ZIZHI_CODE" style="width:99%" class="span12" check-type="maxlength" maxlength="36" name="ZIZHI_CODE" fieldname="ZIZHI_CODE" type="text" /></td>
									<td><input id="ZENG_VALID_DATE"   style="width:70%" fieldtype="date" fieldformat="YYYY-MM-DD" name="ZENG_VALID_DATE" fieldname="ZENG_VALID_DATE" class="Wdate" type="text" onClick="WdatePicker()" /><img onclick="removeZengxiang(this)" style="cursor: pointer;" title="删除" src="/wndjssg/img/sg/icon-removeZz.jpg"><img onclick="addZengxiang(this)" style="cursor: pointer;" title="增加" src="/wndjssg/img/sg/icon-addZz.jpg"></td>
								</tr>
								<% 
									if("register".equals(type)){
										...
										<tr>
											...
											<td><select id="ZIZHI_DENGJI"  class="span12" style="width:99%" name="ZIZHI_DENGJI" fieldname="ZIZHI_DENGJI"><option value="">等级</option></select></td>
											<td><input id="ZIZHI_CODE" style="width:99%" class="span12" check-type="maxlength" maxlength="36" name="ZIZHI_CODE" fieldname="ZIZHI_CODE" type="text" /></td>
											<td><input id="ZENG_VALID_DATE"   style="width:70%" fieldtype="date" fieldformat="YYYY-MM-DD" name="ZENG_VALID_DATE" fieldname="ZENG_VALID_DATE" class="Wdate" type="text" onClick="WdatePicker()"/><img onclick="removeZengxiang(this)" style="cursor: pointer;" title="删除" src="/wndjssg/img/sg/icon-removeZz.jpg"></td>
										</tr>
										<tr>
											<td>
												<input id="SG_ENTERPRISE_ZEN_ZIZHI_UID" style="width:99%" class="span12" name="SG_ENTERPRISE_ZEN_ZIZHI_UID" fieldname="SG_ENTERPRISE_ZEN_ZIZHI_UID" type=hidden />
			        ...
			        <tr>
				        <th width="15%" class="right-border bottom-border text-right">驻锡地址</th>
				        <td  class="bottom-border right-border" >
					...
					<tr>
						...
						<td  class="right-border bottom-border">
							<input id="PHONE" class="span12" style="width:35%" placeholder="必填" check-type="required" check-type="maxlength" maxlength="36" name="PHONE" fieldname="PHONE" type="text" />
							<font style="color:red;font-size: 16px"><b>*</b></font>
						</td>
					</tr>
					<tr>
						<th width="15%" class="right-border bottom-border text-right">公司传真</th>
						<td  class="right-border bottom-border">
					...
					<tr>
						...
						<td  class="right-border bottom-border">
							<input id="URL" class="span12" style="width:35%" check-type="maxlength" maxlength="36" name="URL" fieldname="URL" type="text" />
						</td>
					</tr>
					<tr>
						<th width="15%" class="right-border bottom-border text-right">法人代表</th>
						<td  class="right-border bottom-border">
							<input id="FAREN" class="span12" style="width:35%" placeholder="必填" check-type="required" check-type="maxlength" maxlength="36" name="FAREN" fieldname="FAREN" type="text" />
							<font style="color:red;font-size: 16px"><b>*</b></font>
						</td>
					</tr>
					<tr>
						<th width="15%" class="right-border bottom-border text-right">法人职称</th>
						<td  class="right-border bottom-border">
					...
					<tr>
						<th width="15%" class="right-border bottom-border text-right">法人代表移动电话</th>
						<td  class="right-border bottom-border">
							<input id="FAREN_MOBILE" style="width:35%"  class="span12" check-type="maxlength" maxlength="11" name="FAREN_MOBILE" fieldname="FAREN_MOBILE" type="text" />
							<span style="color: red;" id="ers"></span>
						</td>
					</tr>
					<tr>
						<th width="15%" class="right-border bottom-border text-right">驻锡负责人</th>
						<td  class="right-border bottom-border">
							<input id="ZHUXI_FZR" style="width:35%" class="span12" placeholder="必填" check-type="required" check-type="maxlength" maxlength="36" name="ZHUXI_FZR" fieldname="ZHUXI_FZR" type="text" />
							<font style="color:red;font-size: 16px"><b>*</b></font>
						</td>
					</tr>
					<tr>
						<th width="15%" class="right-border bottom-border text-right">驻锡负责人移动电话</th>
						<td  class="right-border bottom-border">
							<input id="ZHUXI_MOBILE" style="width:35%" onblur="checkPhone(this)" class="span12" check-type="maxlength" maxlength="11" name="ZHUXI_MOBILE" fieldname="ZHUXI_MOBILE" type="text" />
							<span style="color: red;" id="ers"></span>
						</td>
					</tr>
					<tr>
						...
						<td  class="right-border bottom-border">
							<input id="LIANXIREN" style="width:35%" onblur="checkPhone(this)" class="span12" placeholder="必填" check-type="required" check-type="maxlength" maxlength="36" name="LIANXIREN" fieldname="LIANXIREN" type="text" />
							<font style="color:red;font-size: 16px"><b>*</b></font>
						</td>
					</tr>
					<tr>
						...
						<td  class="right-border bottom-border">
							<input id="LIANXIREN_MOBILE" style="width:35%" onblur="checkPhone(this)" class="span12" placeholder="必填" check-type="required" check-type="maxlength" maxlength="11" name="LIANXIREN_MOBILE" fieldname="LIANXIREN_MOBILE" type="text" />
							<font style="color:red;font-size: 16px"><b>*</b></font>
							<span style="color: red;" id="ers"></span>
						</td>
					</tr>
					<tr>
						<th width="15%" class="right-border bottom-border text-right">联系人Email</th>
						<td  class="right-border bottom-border">
						        	...
						        	<table class="B-table" width="100%" id="jx_List">
										...
										<tr id="jx_cloneTR" style="display:none;" class="constant_tr"><!-- 用来复制 -->
											<td>
												...
												<input id="CR_NAME" class="span12" style="width:100%" check-type="maxlength" maxlength="36" name="CR_NAME" fieldname="CR_NAME" type="text" />
											</td>
											<td>
											...
											<td><img onclick="removeTR(this,'jx')" style="cursor: pointer;" title="删除" src="/wndjssg/img/sg/icon-removeZz.jpg"><img onclick="addTR(this,'jx')" style="cursor: pointer;" title="增加" src="/wndjssg/img/sg/icon-addZz.jpg"></td>
										</tr>
					        	...
					        	<table class="B-table" width="100%" id="xm_List">
										...
										<tr id="xm_cloneTR" style="display:none;" class="constant_tr"><!-- 用来复制 -->
											<td>
												...
												<input id="PROJECT_NAME" class="span12" style="width:100%" check-type="maxlength" maxlength="36" name="PROJECT_NAME" fieldname="PROJECT_NAME" type="text" />
											</td>
											...
											<td><img onclick="removeTR(this,'xm')" style="cursor: pointer;" title="删除" src="/wndjssg/img/sg/icon-removeZz.jpg"><img onclick="addTR(this,'xm')" style="cursor: pointer;" title="增加" src="/wndjssg/img/sg/icon-addZz.jpg"></td>
										</tr>
										<tr  class="constant_tr">
											<td>
												<input type="hidden" id="SG_E_CREDIT_PROJECTS_FILEUPLOAD" fieldname="SG_E_CREDIT_PROJECTS_FILEUPLOAD" name = "SG_E_CREDIT_PROJECTS_FILEUPLOAD"/>

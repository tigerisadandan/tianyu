...
function doSelectPerson(){
	//$.each($("#DT1").find("input:checkbox[name='doSelect']"),function(){
		...
		if($("#DT1").find("input:checkbox[name='doSelect']:checked").size()>0){
			optype = 0;
			$(window).manhuaDialog({"title":"退回","type":"text","content":"${pageContext.request.contextPath }/jsp/business/jl/jlpersion-because.jsp","modal":"3"});	
		}
		else{
			alert("请选择人员");  
			}
	...
	if($("#DT1").getSelectedRowIndex()==-1)
	 {
	    ...
	    return
	     ...
	     if(status==30){
	    	  ...
	    	  var t_id=tempJson.PERSON_LIBRARY_UID;
	    	  
	    	  var u_id=tempJson.JL_PERSON_UID;
	    	  window.open("${pageContext.request.contextPath }/jlpersonadd/"+t_id+"/"+u_id,"人员信息查看");//传递一个ID给详细页面，用于查找 
			 // $.ajax({
		...
		//			});
             ...
             window.open("${pageContext.request.contextPath }/jlpersonedit/"+tempJson.PERSON_LIBRARY_UID,"人员信息查看");//传递一个ID给详细页面，用于查找 

        	// $(window).manhuaDialog({"title":"监理企业信息库>审核","type":"text","content":"${pageContext.request.contextPath }/jsp/business/jl/jlperson-edit.jsp","modal":"1"});
              }
...
function clickRadioShowDate(){
	if($("input:radio[name='SHZT']:checked").val()==30){
		...
		//控制一些字段的显示
		$("#doSelect").show();
		$("#doSelect").attr("fieldname","JL_PERSON_UID");
		$("#TIJIAO_DATE").show();
...
function doDm(obj){
	return "<a href='javascript:void(0)' title='登陆代码:"+obj.DENGLU_CODE+"' >"+obj.PERSON_NAME+"</a>";
}
...
function doExecl(tabId){
	   $(window).manhuaDialog({"title":"导出","type":"text","content":"/wndjsbg/jsp/framework/print/TabListEXP.jsp?tabId="+tabId+"&dao=jlPersonLibraryDaoImpl&jsonStr="+jsonStr,"modal":"3"});
}
</script>
</head>
<body>
	...
	<div class="row-fluid">
		<div class="B-small-from-table-autoConcise">
			...
			<div class="overFlowX">
	            ...
	            <table width="100%" print="true" class="table-hover table-activeTd B-table" id="DT1" type="single"  pageNum="11">
	              <thead>
	                <tr>
	                		
	                		<th name="XH" id="_XH" style="width:10px" colindex=1 tdalign="center">&nbsp;#&nbsp;</th>
	                		<th fieldname="JL_PERSON_UID" tdalign="center" colindex=2 CustomFunction="doRandering" noprint="true">&nbsp;&nbsp;</th>
	                        <th fieldname="PERSON_NAME" width="15%" colindex=3 tdalign="center" CustomFunction="doDm">&nbsp;姓名&nbsp;</th>
							<th fieldname="COMPANY_NAME" width="30%" colindex=4 tdalign="center" maxlength="30" CustomFunction="doCn">&nbsp;监理单位名称&nbsp;</th>
							<!-- <th fieldname="DENGLU_CODE" width="20%" colindex=5 tdalign="center" maxlength="30" hidden>&nbsp;监理单位登录code&nbsp;</th>  -->
							<th fieldname="SEX" width="4%" colindex=6  tdalign="center" >&nbsp;性别&nbsp;</th>
							<th fieldname="SHENFENZHENG" width="20%" colindex=7 tdalign="center" maxlength="30">&nbsp;身份证&nbsp;</th>
							<th fieldname="ZHICHENG_NAME" width="10%" colindex=8 tdalign="center" maxlength="30" >&nbsp;职称&nbsp;</th>
						    <th fieldname="PHONE" width="10%" colindex=9 tdalign="center" maxlength="30" >&nbsp;联系电话&nbsp;</th>
							<th fieldname="TIJIAO_DATE"  width="10%" colindex=10 tdalign="center" >&nbsp;提交时间&nbsp;</th>
							<th fieldname="SHENHE_DATE"  width="10%" colindex=11 tdalign="center" >&nbsp;审核时间&nbsp;</th>
	                </thead>
	              	<tbody></tbody>
	           </table>
	       </div>

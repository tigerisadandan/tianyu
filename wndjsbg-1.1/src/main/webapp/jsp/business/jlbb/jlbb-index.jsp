...
<%--		window.open("${pageContext.request.contextPath }/jsp/business/sgbb/sgbb-add.jsp","施工报备-新增");--%>
    ...
    $("#btnClear").click(function() {
        ...
        $("input:radio[name='JLBB_STATUS']")[3].checked = true;
        ...
        $("#btnQuery").click();
        if($("input:radio[name='JLBB_STATUS']:checked").val()=="2"){
...
function doQuery(){
	var status_v = $("input:radio[name='JLBB_STATUS']:checked").val();
	if(status_v=="2"){
		//$("#KB_DATE").val(getCudate());
		$("input:checkbox[name='BID_TYPE']")[3].checked = true;
	}else{
...
function init(){
	...
	$("#xmbh_v").hide();
	$("#xmbh").hide();
	$.each($("input:radio[name='JLBB_STATUS']"),function(){
...
function ankzFun(){
	...
	if(ckyzbbbxx=='ckyzbbbxx'){
		flag1=false;
		$("input:radio[name='JLBB_STATUS']")[1].disabled=false;
	}
	
	var ckwzbbbxx=$("#ckwzbbbxx").val();
	if(ckwzbbbxx=='ckwzbbbxx'){
		flag2=false;
		$("input:radio[name='JLBB_STATUS']")[2].disabled=false;
	}
	var cktbzbbxx=$("#cktbzbbxx").val();
	if(cktbzbbxx=='cktbzbbxx'){
		flag3=false;
		$("input:radio[name='JLBB_STATUS']")[3].disabled=false;
	}
	...
	if(flag1){
		$("input:radio[name='JLBB_STATUS']")[1].checked=false;
	}
	if(flag2){
		$("input:radio[name='JLBB_STATUS']")[2].checked=false;
	}
	if(flag3){
		$("input:radio[name='JLBB_STATUS']")[3].checked=false;
	}
	if(flag4){
...
function doRandering(obj){
	...
	showHtml = "<a href='javascript:rowView("+obj.STATUS+","+obj.JLBB_UID+");' title='"+title+"'><i class='icon-file showXmxxkInfo'></i></a>";
	return showHtml;
...
function rowView(status,uid){
	window.open("${pageContext.request.contextPath }/jsp/business/jlbb/jlbb-view.jsp?id="+uid);
}
...
function doPrint(obj){
	return "<a href='javascript:void(0)'><i class='icon-print' onclick='doLoad("+obj.JLBB_UID+")'  title='打印登记表'></i></a>";
}
function doLoad(uid){
	//window.open("${pageContext.request.contextPath }/jlbb/jlbbController/query4Print?bbid="+uid+"&type=pdf","打印登记表");
	window.open("${pageContext.request.contextPath}/jlbb/jlbbController?print&bbid="+uid,"打印登记表");
//	$.ajax({
//		url : "${pageContext.request.contextPath}/jlbb/jlbbController?print&bbid="+uid, 
//		data : {},
//		cache : false,
//		async :	false,
//		dataType : "json",  
...
function doWgjs(obj){
	...
	if(obj.STATUS=="20"){
		return "<a href='javascript:void(0)' onclick=lockOp("+obj.JLBB_UID+",'doBb')><div style='width:16px;'><img src='${pageContext.request.contextPath }/images/sgxt/lock.png' title='已锁定,点击完工解锁'/></div></a>";
				...
				<table class="B-table" width="100%">
					...
					<tr>
						...
						<td class="right-border bottom-border" width="10%" colspan="3">
							<input class="span12" id="JLBB_STATUS" type="radio" name="JLBB_STATUS" kind="dic" src="T#FS_DIC_TREE: DIC_CODE as c:DIC_VALUE as t:PARENT_ID ='1000000000040' order by to_number(DIC_CODE) DESC" operation="=" fieldname="TABA.STATUS" />
						</td>
					...
					<tr>
						...
						<td class="right-border bottom-border" width="10%"  >
							<input class="span12" type="text" id="PROJECT_CODE" name="PROJECT_CODE" fieldname="TABA.PROJECT_CODE" operation="like" >
						</td>
						<th width="7%" class="right-border bottom-border text-right">报备编码</th>
						<td class="right-border bottom-border" width="10%">
							<input class="span12" type="text" id="BB_CODE" name="BB_CODE" fieldname="TABA.BB_CODE" operation="like" >
						</td>
						
			            
						<th width="7%" class="right-border bottom-border text-right">项目名称</th>
						<td class="right-border bottom-border" width="10%">
							<input class="span12" type="text" id="PROJECT_NAME" name="PROJECT_NAME" fieldname="TABA.PROJECT_NAME" operation="like" >
						</td>
						<th width="7%" class="right-border bottom-border text-right">单位名称</th>
						<td class="right-border bottom-border" width="10%">
							<input class="span12" type="text" id="COMPANY_NAME" name="COMPANY_NAME" fieldname="TABA.COMPANY_NAME" operation="like" >
						</td>
						<th width="7%" class="right-border bottom-border text-right">监理人员</th>
						<td class="right-border bottom-border" width="10%">
							<input class="span12" type="text" id="JLRY" name="JLRY" fieldname="TABB.JLRY" operation="like" >
						</td>
	            ...
	            <table width="100%" class="table-hover table-activeTd B-table" id="DT1" type="single"  pageNum="9">
	                <thead>
	                	<tr>
	                		...
	                		<th fieldname="JLBB_UID" colindex=2 tdalign="center" width="1%" Customfunction="doRandering" noprint="true">&nbsp;&nbsp;</th>
	                		<th fieldname="JLBB_UID" colindex=4 tdalign="center" width="1%" Customfunction="doPrint" noprint="true">&nbsp;&nbsp;</th>
							...
							<th fieldname="COMPANY_NAME" colindex=9 tdalign="center" width="15%">&nbsp;监理单位&nbsp;</th>
							<th fieldname="COMPANY_DENGLU_CODE" hidden colindex=9 tdalign="center" width="15%">&nbsp;施工单位登录代码&nbsp;</th>
							<th fieldname="ZJ" colindex=10 tdalign="center" width="7%">&nbsp;总监&nbsp;</th>
							<th fieldname="JLRY" colindex=11 tdalign="center" width="20%" CustomFunction="doRy">&nbsp;监理人员&nbsp;</th>
	                	</tr>
	                </thead>
	              	<tbody></tbody>
	           </table>
	            ...
	            <table width="100%" class="table-hover table-activeTd B-table" id="DT2" type="single"  pageNum="9">
	                <thead>
	                	<tr>
	                		...
	                		<th fieldname="JLBB_UID" colindex=2 tdalign="center"  Customfunction="doWgjs" noprint="true">&nbsp;&nbsp;</th>
	                		<th fieldname="JLBB_UID" colindex=4 tdalign="center" width="1%" Customfunction="doPrint" noprint="true">&nbsp;&nbsp;</th>
							<th fieldname="STATUS" colindex=5 tdalign="center" width="7%" CustomFunction="docolor">&nbsp;状态&nbsp;</th>
							<th fieldname="PROJECT_CODE" colindex=6 tdalign="center" width="15%">&nbsp;招标工程项目编号&nbsp;</th>
							<th fieldname="PROJECT_NAME" colindex=7 tdalign="center" width="20%" CustomFunction="doGc">&nbsp;项目名称&nbsp;</th>
							<th fieldname="BB_CODE" colindex=8 tdalign="center" width="13%" CustomFunction="doCode">&nbsp;报备编码&nbsp;</th>
							<th fieldname="COMPANY_NAME" colindex=9 tdalign="center" width="15%">&nbsp;监理单位&nbsp;</th>
							<th fieldname="COMPANY_DENGLU_CODE" hidden colindex=9 tdalign="center" width="15%">&nbsp;监理单位登录代码&nbsp;</th>
							<th fieldname="ZJ" colindex=10 tdalign="center" width="7%">&nbsp;总监&nbsp;</th>
							<th fieldname="JLRY" colindex=11 tdalign="center" width="20%" CustomFunction="doRy">&nbsp;监理人员人员&nbsp;</th>
	                	</tr>
	                </thead>
	              	<tbody></tbody>
	           </table>

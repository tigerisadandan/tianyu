		...
		success : function(response) {
			if(response!=""){
				...
				$.each(cls,function(i){
					...
					if(this.URL!=""){
						showHtml += '<button id="btnInsert" onclick="showTbMsg(\''+this.URL+'\',\''+ywlz_uid+'\')" class="btn" type="button" style="font-family:SimYou,Microsoft YaHei;font-weight:bold;">修改</button>&nbsp;&nbsp;';
						showHtml += '<button id="btnInsert" onclick="viewTbMsg(\''+this.URL+'\',\''+ywlz_uid+'\')" class="btn" type="button" style="font-family:SimYou,Microsoft YaHei;font-weight:bold;">查看</button>';
						}
...
//	${pageContext.request.contextPath}/"+this.URL+"/detail:"+this.YWLZ_UID;	
	window.open("${pageContext.request.contextPath}/"+url+"/update:"+ywlzuid,"填报信息修改");
}

function viewTbMsg(url,ywlzuid){
//	${pageContext.request.contextPath}/"+this.URL+"/detail:"+this.YWLZ_UID;	

...
function rowView(obj){
	...
	$(window).manhuaDialog({"title":title1,"type":"text","content":"${pageContext.request.contextPath }/jsp/business/ywlz/ywlz-single-add.jsp?spyw_uid="+${ywid},"modal":"2"});
}
...
function rowSh(obj){
	...
	if(${ywid}=="119"){
		$(window).manhuaDialog({"title":title1,"type":"text","content":"${pageContext.request.contextPath }/jsp/business/ywlz/bu-sp-ywlzsp-sp.jsp?type=ywlzsh&spyw_uid="+${ywid},"modal":"1"});
	}else{
	$(window).manhuaDialog({"title":title1,"type":"text","content":"${pageContext.request.contextPath }/jsp/business/ywlz/bu-sp-ywlzsp-sp.jsp?type=ywlzsh&spyw_uid="+${ywid},"modal":"1"});
	}
}
	            ...
	            <table width="100%" class="table-hover table-activeTd B-table" id="DT1" type="single"  pageNum="18">
	                <thead>
	                	<tr>
							...
							<th fieldname="COMPANY_NAME" colindex=5 tdalign="center">&nbsp;所属公司&nbsp;</th>

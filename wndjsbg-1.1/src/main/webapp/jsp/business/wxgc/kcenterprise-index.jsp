...
$(function() {
	...
	$("#btnUpdate").click(function() {
		...
		$(window).manhuaDialog({"title":"勘察设计企业信息库>修改","type":"text","content":"${pageContext.request.contextPath }/jsp/business/wxgc/kcenterprise-add.jsp?type=update","modal":"1"});
	});
...
function rowView(obj){
	...
	$("#resultXML").val($("#DT1").getSelectedRow());
	$(window).manhuaDialog({"title":"勘察设计企业信息库>查看","type":"text","content":"${pageContext.request.contextPath }/jsp/business/wxgc/kcenterprise-add.jsp?type=detail","modal":"1"});
}
...
function editorU(obj){
	...
	$("#resultXML").val($("#DT1").getSelectedRow());
	$(window).manhuaDialog({"title":"勘察设计企业信息库>审核","type":"text","content":"${pageContext.request.contextPath }/jsp/business/wxgc/kcenterprise-sh.jsp?type=update","modal":"1"});
	            ...
	            <table width="100%" class="table-hover table-activeTd B-table" id="DT1" type="single"  pageNum="18">
	                <thead>
	                	<tr>
	                		...
	                		<th fieldname="KC_ENTERPRISE_UID" colindex=2 tdalign="center" style="width:10px" CustomFunction="doeditor" noprint="true">&nbsp;&nbsp;</th>

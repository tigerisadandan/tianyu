...
$(function() {
	...
	$("#btnUpdate").click(function() {
		...
		$(window).manhuaDialog({"title":"绿化企业信息库>修改","type":"text","content":"${pageContext.request.contextPath }/jsp/business/wxgc/lhenterprise-add.jsp?type=update","modal":"1"});
	});
...
function rowView(obj){
	...
	$("#resultXML").val($("#DT1").getSelectedRow());
	$(window).manhuaDialog({"title":"绿化企业信息库>查看","type":"text","content":"${pageContext.request.contextPath }/jsp/business/wxgc/lhenterprise-add.jsp?type=detail","modal":"1"});
}
...
function editorU(obj){
	...
	$("#resultXML").val($("#DT1").getSelectedRow());
	$(window).manhuaDialog({"title":"绿化企业信息库>审核","type":"text","content":"${pageContext.request.contextPath }/jsp/business/wxgc/lhenterprise-sh.jsp?type=update","modal":"1"});
...
<%--      						 <input type=radio value="1" name="status" onclick="javascript:checkStatus(1)">已审入库&nbsp;&nbsp;--%>
	            ...
	            <table width="100%" class="table-hover table-activeTd B-table" id="DT1" type="single"  pageNum="18">
	                <thead>
	                	<tr>
	                		...
	                		<th fieldname="LH_ENTERPRISE_UID" colindex=1 tdalign="center" style="width:10px"CustomFunction="doeditor" noprint="true">&nbsp;&nbsp;</th>
							...
							<th fieldname="ZHIZHAO_VALID_SV" colindex=9 tdalign="center" style="width:8px">&nbsp;执照有效期&nbsp;</th>

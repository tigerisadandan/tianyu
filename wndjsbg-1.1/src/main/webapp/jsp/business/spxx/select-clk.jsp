...
$(function() {
    ...
    $("#btnYet").click(function(){
		...
		window.opener.doSelectCl(rowJson);
		window.close();
	})
...
function rowView(index){
	...
	$("#resultXML").val($("#DT1").getSelectedRow());
	$(window).manhuaDialog({"title":"审批业务材料库>详细信息","type":"text","content":"${pageContext.request.contextPath }/jsp/business/spxx/bu-sp-clk-add.jsp?type=detail","modal":"2"});
}
...
function rowUpdate(obj){
	...
	$("#resultXML").val(data);
	$(window).manhuaDialog({"title":"审批业务材料库>查看","type":"text","content":"${pageContext.request.contextPath }/jsp/business/spxx/bu-sp-clk-add.jsp?type=detail","modal":"2"});
				...
				<table class="B-table" width="100%">
					...
					<tr>
						...
						<td class="right-border bottom-border" width="20%">
							<input class="span12" type="text" id="QCLMC" name="CLMC" fieldname="CLMC" operation="like" >
						</td>
	            ...
	            <table width="100%" class="table-hover table-activeTd B-table" id="DT1" type="single"  pageNum="18">
	                <thead>
	                	<tr>
							...
							<th fieldname="CLMC" colindex=1 tdalign="center" maxlength="30" CustomFunction="caozuoFun" >&nbsp;材料名称&nbsp;</th>

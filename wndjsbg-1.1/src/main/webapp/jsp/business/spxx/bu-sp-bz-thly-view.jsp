     ...
     <form method="post" id="buSpBzThlyForm"  >
      <table class="B-table" width="100%" >
        ...
        <tr>
			...
			<td class="bottom-border right-border" style="width:23%">
				<button class="btn btn-link" id="spywid" type="button" onclick="showSpyw()" style="width:95%">
				<input id="SPYW_UID" class="right-border bottom-border text-left" style="width:95%" fieldname="SPYWMC" name="SPYWMC" readOnly type="text" value='--请选择--' />
<%--					<i class="icon-edit"></i>--%>
				</button>
			</td>
			...
			<th width="8%" class="right-border bottom-border text-right">审批步骤</th>
       	 	<td class="bottom-border right-border" width="23%">
       	 		<select id="spbz_uid" class="span12" style="width:50%" name="SPBZ_UID" fieldname="SPBZ_UID"  kind="dic" src="T#bu_sp_bz:spbz_uid as c:bzmc as t" defaultMemo="--请选择--"></select>  
       	 	</td>

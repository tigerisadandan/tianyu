...
var controllername= "${pageContext.request.contextPath }/jxsb/jxsbDsjjController.do";
var type ="<%=type%>";
//页面初始化
$(function() {
	init();
	...
	$("#btnQuery").click(function() {
		//生成json串
		var data = combineQuery.getQueryCombineData(queryForm,frmPost,jxsbDsjjList);
		//调用ajax插入
		defaultJson.doQueryJsonList(controllername+"?query",data,jxsbDsjjList);
	});
	//按钮绑定事件(保存)
	$("#btnSave").click(function() {
		if($("#jxsbDsjjForm").validationButton())
		{
		    //生成json串
		    var data = Form2Json.formToJSON(jxsbDsjjForm);
		  //组成保存json串格式
		    var data1 = defaultJson.packSaveJson(data);
		  //调用ajax插入
		    if($("#ID").val() == "" || $("#ID").val() == null){
    			defaultJson.doInsertJson(controllername + "?insert", data1,jxsbDsjjList);
    			$("#jxsbDsjjForm").clearFormResult();
    		}else{
    			defaultJson.doUpdateJson(controllername + "?insert", data1,jxsbDsjjList);
    		}
		}else{
			requireFormMsg();
		  	return;
...
<%--		}--%>
<%--		//表单赋值--%>
<%--		$("#$("#jxsbDsjjForm")").setFormValues(tempJson);--%>
<%--	}--%>
}
...
function tr_click(obj){
	...
	$("#jxsbDsjjForm").setFormValues(obj);
}
...
function rowView(index){
	var obj = $("#jxsbDsjjList").getSelectedRowJsonByIndex(index);
...
<div class="row-fluid">
    ...
    <div class="overFlowX">
	<table class="table-hover table-activeTd B-table" id="jxsbDsjjList" width="100%" type="single" pageNum="5">
		<thead>
			<tr>
 			    <th  name="XH" id="_XH" style="width:10px" colindex=1 tdalign="center">&nbsp;#&nbsp;</th>
				<th fieldname="JXSB_DSJJ_UID" colindex=0 tdalign="center" >&nbsp;&nbsp;</th>
				<th fieldname="JXSB_SYGL_UID" colindex=1 tdalign="center" >&nbsp;&nbsp;</th>
				<th fieldname="BY_COMPANY_DL_UID" colindex=2 tdalign="center" >&nbsp;维保单位对应uid&nbsp;</th>
				<th fieldname="DS_DATE" colindex=3 tdalign="center" >&nbsp;顶升日期&nbsp;</th>
				<th fieldname="NEW_HEIGHT" colindex=4 tdalign="center" >&nbsp;本次顶升高度&nbsp;</th>
				<th fieldname="DS_HEIGHT" colindex=5 tdalign="center" >&nbsp;顶升后塔吊总高度&nbsp;</th>
				<th fieldname="FZJJ" colindex=6 tdalign="center" >&nbsp;附着间距&nbsp;</th>
				<th fieldname="ZYD_HEIGHT" colindex=7 tdalign="center" maxlength="30" >&nbsp;塔身自由端高度&nbsp;</th>
				<th fieldname="FQGD" colindex=8 tdalign="center" >&nbsp;本次附墙高度&nbsp;</th>
				<th fieldname="CZ_REN" colindex=9 tdalign="center" maxlength="30" >&nbsp;操作人员&nbsp;</th>
				<th fieldname="CZ_REN_UID" colindex=10 tdalign="center" maxlength="30" >&nbsp;操作人UID&nbsp;</th>
				<th fieldname="EVENT_UID" colindex=11 tdalign="center" maxlength="30" >&nbsp;事件编号&nbsp;</th>
				<th fieldname="ENABLED" colindex=12 tdalign="center" >&nbsp;是否有效&nbsp;</th>
				<th fieldname="DESCRIBE" colindex=13 tdalign="center" maxlength="30" >&nbsp;备注&nbsp;</th>
				<th fieldname="CREATED_UID" colindex=14 tdalign="center" maxlength="30" >&nbsp;创建人编号&nbsp;</th>
				<th fieldname="CREATED_NAME" colindex=15 tdalign="center" maxlength="30" >&nbsp;创建人&nbsp;</th>
				<th fieldname="CREATED_DATE" colindex=16 tdalign="center" >&nbsp;创建时间&nbsp;</th>
				<th fieldname="UPDATE_UID" colindex=17 tdalign="center" maxlength="30" >&nbsp;更新人编号&nbsp;</th>
				<th fieldname="UPDATE_NAME" colindex=18 tdalign="center" maxlength="30" >&nbsp;更新人&nbsp;</th>
				<th fieldname="UPDATE_DATE" colindex=19 tdalign="center" >&nbsp;更新时间&nbsp;</th>
				<th fieldname="SERIAL_NO" colindex=20 tdalign="center" >&nbsp;排序号&nbsp;</th>
             </tr>
		</thead>
		<tbody>
           </tbody>
	...
	<div class="B-small-from-table-autoConcise">
     ...
     <form method="post" id="jxsbDsjjForm"  >
      <table class="B-table" width="100%" >

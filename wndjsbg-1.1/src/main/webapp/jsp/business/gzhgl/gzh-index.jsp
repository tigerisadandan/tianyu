...
$(function() {
	...
	$("#btnInsert").click(function() {
		$(window).manhuaDialog({"title":"告知会>添加","type":"text","content":"${pageContext.request.contextPath }/jsp/business/gzhgl/gzh-add.jsp?type=insert","modal":"2"});
	});
...
//查看详细信息
	...
	var showHtml = "";
	showHtml = "<a href='javascript:rowView1("+obj.GZH_UID+");' title='查看详细信息'><i class='icon-file showXmxxkInfo'></i></a> &nbsp;&nbsp;<a href='javascript:rowView2("+obj.GZH_UID+");' title='修改'><i class='icon-pencil'></i></a>";
	return showHtml;
	}
function rowView1(v){
...
function rowView2(v){
	$(window).manhuaDialog({"title":"告知会>修改","type":"text","content":"${pageContext.request.contextPath }/jsp/business/gzhgl/gzh-edit.jsp?type=edit&gzhId="+v,"modal":"2"});
}
//时间操作
		...
		<div class="B-small-from-table-autoConcise">
			<h4 class="title">
				...
				<span class="pull-right">  
					<button id="btnInsert" class="btn" type="button" style="font-family:SimYou,Microsoft YaHei;font-weight:bold;">添加告知会</button>
				</span>
			</h4>
				...
				<table class="B-table" width="100%">
					...
					<tr>
						...
						<td class="right-border bottom-border" width="50%">
							<input id="HUIYI_DATE" type="text" fieldtype="date" fieldformat="YYYY/MM/DD" fieldname="HUIYI_DATE" class="Wdate" onClick="WdatePicker()" name = "HUIYI_DATE"  operation=">="    /> ~
							<input id="HUIYI_DATE" type="text" fieldtype="date" fieldformat="YYYY/MM/DD" fieldname="HUIYI_DATE" class="Wdate" onClick="WdatePicker()" name = "HUIYI_DATE"  operation="<=" />

...
<div class="container-fluid">
	...
	<div class="row-fluid">
		<div class="B-small-from-table-autoConcise">
		    ...
		    <form method="post" id="TONGZHIForm" action="${pageContext.request.contextPath }/nbgl/inform01/WorkInformController?update"> 
	                ...
	                <thead>
	                	...
	                	<tr>
			       	 	 ...
			       	 	 <td colspan="3" class="bottom-border right-border">
			       	 		<div id="dis">
							   <input id="SHENGXIAO_DATE" type="text" fieldtype="date" fieldformat="YYYY-MM-DD HH:mm" fieldname="SHENGXIAO_DATE" class="Wdate" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" name = "SHENGXIAO_DATE" readonly="readonly"/>
							</div>
						 </td>
						 ...
						 <th width="15%" class="right-border bottom-border text-right">失效时间</th>
			       	 	<td colspan="3" class="bottom-border right-border">
			       	 		<div id="dis">
							  <input id="SHIXIAO_DATE" type="text" fieldtype="date" fieldformat="YYYY-MM-DD HH:mm" fieldname="SHIXIAO_DATE" class="Wdate" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" name = "SHIXIAO_DATE" readonly="readonly"/>
							</div>
						</td>
			       	   </tr>
	                </thead>

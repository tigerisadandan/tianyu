...
function OpenMiddleWindow_alter(){
	...
	$(window).manhuaDialog({"title":"项目储备库>修改","type":"text","content":"${pageContext.request.contextPath }/jsp/business/bzwj/bu_sp_bzwj-add.jsp?xx="+json_xg+"&&id="+id+"&zt="+zt+"&pch="+pch,"modal":"1"});
}

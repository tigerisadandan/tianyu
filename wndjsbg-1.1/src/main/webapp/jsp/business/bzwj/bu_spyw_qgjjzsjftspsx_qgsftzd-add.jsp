...
$(function() {
		  ...
		  //调用ajax插入
		   if(type=="insert"){
    			...
    			var json=$("#resultXML").val();//接受返回的数据 
		    	 ...
		    	 $("#QGJJZSJFTSPSX_QGSFTZD_UID").val(resultobj.QGJJZSJFTSPSX_QGSFTZD_UID);
		    	 $("#btnSave2").show();
		    	 type="update";
    	  	}else if(type=="update"){
	...
	$("#btnSave2").click(function() {  //打印
        $.ajax({
			url : controllername + "download?uid="+$("#QGJJZSJFTSPSX_QGSFTZD_UID").val()+"&filename="+filename,
			cache : false,
			async : false,
			dataType : "json",
			type : 'post',
     ...
     <form method="post" id="buSpywZzhydjForm"   > 
      <h4 class="title" align="center">无锡市建筑墙体材料改革办公室新区办事处</h4>
          ...
          <div align="left" style="width: 800px;" >  
                 <span style="font-size: 17px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;兹有<u><span id="gs"></span></u>的<u><span id="xm"></span></u>工程项目，总建筑面积为 <u><input placeholder="必填" check-type="required"  onkeyup="jisuan(this)"  maxlength="11"  style="width: 100px;text-align: right;" class="cc-input1"  id="JZMJ" type="text"  fieldname="JZMJ" name = "JZMJ"  /></u> ㎡,</span>
...
<tr style="height: 35px;;"> 
  ...
  <tr style="height: 35px;"> 
    <td align="right" style="border-top: 0px;">   日期：<input name="RQ" type="text" id="RQ" fieldname="RQ" style="width: 20%" onclick="WdatePicker()" fieldformat="YYYY-MM-DD" class="Wdate"> 
    编号：<I>NO</I>&nbsp;<span id="qtbh"></span><input style="width: 15%;" maxlength="30"   class="cc-input1" placeholder="必填" check-type="required" id="BH" type="hidden"  fieldname="BH" name = "BH"  /></td>
  </tr>
</table>
</div>
      </form>

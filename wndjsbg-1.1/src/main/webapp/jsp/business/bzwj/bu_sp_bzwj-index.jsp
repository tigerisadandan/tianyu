...
$(function() {
	...
	$("#btnInsert").click(function() {
		$(window).manhuaDialog({"title":"步骤文件>新增","type":"text","content":"${pageContext.request.contextPath }/jsp/business/bzwj/bu_sp_bzwj-add.jsp?type=insert","modal":"1"});
	});
	//按钮绑定事件(修改)
	$("#btnUpdate").click(function() {
		...
		$(window).manhuaDialog({"title":"步骤文件>修改","type":"text","content":"${pageContext.request.contextPath }/jsp/business/bzwj/bu_sp_bzwj-add.jsp?type=update","modal":"1"});
	});
	//按钮绑定事件（导出EXCEL）
...
function rowView(index){
	...
	$("#resultXML").val($("#DT1").getSelectedRow());
	$(window).manhuaDialog({"title":"步骤文件>详细信息","type":"text","content":"${pageContext.request.contextPath }/jsp/business/bzwj/bu_sp_bzwj-add.jsp?type=detail","modal":"1"});
}
</script>
</head>
<body>
	            ...
	            <table width="100%" class="table-hover table-activeTd B-table" id="DT1" type="single"  pageNum="18">
	                <thead>
	                	<tr>
							...
							<th fieldname="BZWJ_UID" colindex=0 tdalign="center" >&nbsp;步骤文件_UID&nbsp;</th>
							<th fieldname="CLK_UID" colindex=1 tdalign="center" >&nbsp;材料UID&nbsp;</th>
							<th fieldname="SPBZ_UID" colindex=2 tdalign="center" >&nbsp;审批步骤UID&nbsp;</th>

...
function rowView(obj){
	...
	$("#resultXML").val(data);
	$(window).manhuaDialog({"title":"建设单位>详细信息","type":"text","content":"${pageContext.request.contextPath }/jsp/business/project/js-company-add.jsp?type=detail","modal":"2"});
}
...
function rowSh(obj){
	...
	$("#resultXML").val(data);
	$(window).manhuaDialog({"title":"建设单位>详细信息","type":"text","content":"${pageContext.request.contextPath }/jsp/business/project/js-company-add.jsp?type=update","modal":"2"});
}
...
<%--			<h4 class="title">
			...
			<form method="post" id="queryForm">
				<table class="B-table" width="100%">
				  ...
				  <select class="span12" id="WAIDI_Y" operation="=" name="WAIDI_Y" fieldname="WAIDI_Y" >
	            ...
	            <table width="100%" class="table-hover table-activeTd B-table" id="DT1" type="single"  pageNum="18">
	                <thead>
	                	<tr>
	                		...
	                		<th fieldname="JS_COMPANY_UID" colindex=0 tdalign="center"  CustomFunction="caozuoFun" >&nbsp;&nbsp;</th>
							<th fieldname="COMPANY_NAME" colindex=2 tdalign="center" maxlength="30">&nbsp;企业名称&nbsp;</th>
							<th fieldname="USER_NAME" colindex=2 tdalign="center" maxlength="30" >&nbsp;登录名&nbsp;</th>
							<th fieldname=JIGUO_DAIMA colindex=3 tdalign="center" maxlength="30" >&nbsp;组织机构代码&nbsp;</th>
							<th fieldname=ZHIZHAO colindex=3 tdalign="center" maxlength="30" >&nbsp;营业执照注册号&nbsp;</th>
							<th fieldname="WAIDI_Y" colindex=5 tdalign="center" maxlength="30" CustomFunction="sfwd">&nbsp;是否外地企业&nbsp;</th>
							<th fieldname="SHENHENAME" colindex=11 tdalign="center" >&nbsp;审核人&nbsp;</th>
							<th  fieldname="SHENHE_DATE" colindex=13 tdalign="center" >&nbsp;审核时间&nbsp;</th>
							<th id="tijiao"  fieldname="CREATED_DATE" colindex=14 tdalign="center" hidden="hidden">&nbsp;提交时间&nbsp;</th>								
	                	</tr>
	                </thead>
	              	<tbody></tbody>
	           </table>

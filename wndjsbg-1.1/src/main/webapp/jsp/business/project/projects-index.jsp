...
$(function() {
	...
	$("#btnUpdate").click(function() {
		...
		$(window).manhuaDialog({"title":"项目分期>审核","type":"text","content":"${pageContext.request.contextPath }/jsp/business/project/projects-add.jsp?type=update","modal":"2"});
	});
	//按钮绑定事件（导出EXCEL）
...
function rowView(obj){
	...
	$("#resultXML").val(data);
	$(window).manhuaDialog({"title":"项目分期>详细信息","type":"text","content":"${pageContext.request.contextPath }/jsp/business/project/projects-add.jsp?type=detail","modal":"2"});
...
function getCount(){	
	$.ajax({
		url : controllername+"?getProjectCount&type=J",
	//	data : data1,
		cache : false,
		async : false,
		dataType : "json",
...
<%--							<INPUT type="text" class="span12" kind="text" id="STATUS" fieldname="STATUS" value="40" operation="!="/>--%>
							<INPUT type="text" class="span12" id="QSTATUS" fieldname="d.STATUS" value='30'  operation="="/>
							<INPUT type="text" class="span12" id="PROJECTS_TYPE" fieldname="d.PROJECTS_TYPE" value='J'  operation="="/>
					...
					<tr>
						...
						<td class="right-border bottom-border" width="13%">
							<input class="span12" type="text" onkeydown="enterSumbit()" id="QCOMPANYNAME" name="COMPANYNAME" fieldname="j.company_name" operation="like" >
						</td>
						<th width="5%" class="right-border bottom-border text-right">项目名称</th>
						<td class="right-border bottom-border" width="13%">
							<input class="span12" type="text" onkeydown="enterSumbit()" id="GONGCHENG_NAME" name="GONGCHENG_NAME" fieldname="p.GONGCHENG_NAME" operation="like" >
						</td>
						<th width="5%" class="right-border bottom-border text-right">项目分期名称</th>
						<td class="right-border bottom-border" width="13%">
							<input class="span12" type="text" onkeydown="enterSumbit()" id="QPROJECTS_NAME" name="PROJECTS_NAME" fieldname="d.PROJECTS_NAME" operation="like" >
						</td>
			            ...
			            <td width="15%"class="text-left bottom-border text-right">
	            ...
	            <table width="100%" class="table-hover table-activeTd B-table" id="DT1" type="single"  pageNum="18">
	                <thead>
	                	<tr> 
							...
							<th fieldname="PROJECT_NAME" colindex=5 tdalign="center" maxlength="30">&nbsp;项目名称&nbsp;</th>
							<th fieldname="PROJECTS_NAME" colindex=5 tdalign="center" maxlength="30" CustomFunction="xmbhFun">&nbsp;项目分期名称&nbsp;</th>

     	...
     	<table class="B-table" width="100%" >
	        ...
	        <tr>
				<th width="15%" class="right-border bottom-border text-right">营业执照注册号</th>
	       	 	<td class="bottom-border right-border" style="width:32%">
	       	 	<input class="span12" style="width:100%" id="ZHIZHAO" type="text" readonly="readonly" fieldname="ZHIZHAO" name = "ZHIZHAO"  />	     	
	       	 	</td>
	       	 	<th width="15%" class="right-border bottom-border text-right"> 营业执照有效期</th>
	       	 	<td colspan="3" class="bottom-border right-border">
					<input style="width:94%" id="ZHIZHAO_VALID" type="text" readonly="readonly" fieldname="ZHIZHAO_VALID" name = "ZHIZHAO_VALID"  />
				</td>
	        </tr>
	        ...
	        <tr>
				...
				<td  class="right-border bottom-border" colspan="1">
					<input style="width:85%" id="ZHUCE_ZIJIN" type="text"  readonly="readonly" fieldname="ZHUCE_ZIJIN" name = "ZHUCE_ZIJIN"  class="col-xs-10 col-sm-10" />万元			
				</td>

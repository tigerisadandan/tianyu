			...
			$
					.ajax({
						...
						success : function(response) {
							...
							//标记地图
							var imgsrc = "http://api.map.baidu.com/staticimage?width=540&height=340&center=无锡新区&zoom=10"
									+ "&paths="
									+ positionOne
...
<body>
	...
	<div class="container-fluid">
		<div class="row-fluid">
			...
			<div class="B-small-from-table-autoConcise">
				<!-- 审核 -->
				<table id="SP_TABLE" border="1" width="100%" cellpadding="0"
								...
								<div class="overFlowX">
									...
									<form method="post" id="projectsForm">
										...
										<table class="B-table" width="100%">
											...
											<tr id="xmfltr">
												<th width="15%"
													class="right-border bottom-border text-right">项目分类&nbsp;<font id="fontId"
													style="color:red;font-size: 16px"><b>*</b> </font></th>
												<td class="right-border bottom-border"><select
													class="span12" style="width:99%" id="XM_FENLEI_Y" placeholder="必填" check-type="required"
													type="text" fieldname="XM_FENLEI_Y" kind="dic" src="XMFL"
													name="XM_FENLEI_Y">
												</select></td>
											</tr>
											<tr>
											...
											<tr>
												...
												<th width="15%"
													...
													id="WF_XKZ_TH" >危险废物经营许可证编号</th>
												<td class="right-border bottom-border" id="WF_XKZ_TD"
													><input
													class="span12 text-right" style="width:99%" id="WF_XKZ"
													maxlength="20" type="text" fieldname="WF_XKZ" name="WF_XKZ" />

...
<table width="725" border="1" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td width="568" colspan="4" ><p align="left">工程现场进度进度      ：
       ...
       <label class="checkbox inline"><input type="checkbox" id="JCSG"  sv="基础施工" disabled="disabled">基础施工 </label>
       <label class="checkbox inline"><input type="checkbox" id="ZTSG" sv="主体施工" disabled="disabled">主体施工</label>
       <label class="checkbox inline"><input type="checkbox" id="AZZS"  sv="基础施工" disabled="disabled">安装装饰 </label>
       <label class="checkbox inline"><input type="checkbox" id="SZSW" sv="主体施工" disabled="disabled">市政收尾</label>
    </p></td>
  </tr>
  <tr>
    <td width="121" ><p align="left">人脸识别考勤特殊化原因： </p></td>
    <td width="448" colspan="3" fieldname="TSH_YUANYIN">
    </td>
  </tr>
 <tr>

...
$(function() {
	 ...
	 // $("#YWLZ_UID").val(ywlzid);
	   if($("#ZHONGYAO").prop("checked")==true){
		   $("#ZHONGYAO_RY_Y").val("0");  
	   }else{
		   $("#ZHONGYAO_RY_Y").val("1");
	   }
	   if($("#ZHUYAO").prop("checked")==true){
		   $("#ZHUYAO_RY_Y").val("0");  
	   }else{
		   $("#ZHUYAO_RY_Y").val("1");
	   }
		 ...
		 if($("#buSpywZzhydjForm").validationButton()&&yz){
		  ...
		  if(type=="insert"){
		    ...
		    $("#JSXMKQCTHBA_UID").val(resultobj.JSXMKQCTHBA_UID);
    			type="update";
    			$("#btnSave").hide();
    	  }else if(type=="update"){
...
<table style="width: 725px;" border="1" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td width="255" ><input readonly="readonly"  maxlength="255" style="margin: 0;width: 96%"  id="SGDW" type="text"  fieldname="SGDW" name = "SGDW"   /></td>
    <td width="76" ><p align="center">项目经理 </p></td>
    <td width="117" ><input readonly="readonly"  maxlength="255" style="margin: 0;width: 91%"  id="XMJL" type="text"  fieldname="XMJL" name = "XMJL"   /></td>
  </tr>
  <tr>
    <td width="121" ><p align="center">监理单位 </p></td>
    <td width="255" ><input readonly="readonly"  maxlength="255" style="margin: 0;width: 96%"  id="JLDW" type="text"  fieldname="JLDW" name = "JLDW"   /></td>
    <td width="76" ><p align="center">总监 </p></td>
    <td width="117" ><input  maxlength="255" style="margin: 0;width: 91%"  id="ZJ" type="text"  fieldname="ZJ" name = "ZJ"   /></td>
  </tr>
  <tr>
    <td width="121" ><p align="center">工程地点 </p></td>
    <td width="255" ><input readonly="readonly"  maxlength="255" style="margin: 0;width: 96%"  id="GCDD" type="text"  fieldname="GCDD" name = "GCDD"   /></td>
    <td width="76" ><p align="center">建筑面积 </p></td>
    <td width="117" ><input maxlength="255" style="margin: 0;width: 91%"  id="JZMJ" type="text"  fieldname="JZMJ" name = "JZMJ"   /></td>
  </tr>
  <tr>
    <td width="451" colspan="3" ><p align="center">项目计划开工及考勤常态化开始时间 </p></td>
    <td width="117" ><input class="Wdate" readonly="readonly"  maxlength="255" style="margin: 0;width: 91%" onClick="WdatePicker()"    data-date-format="YYYY-MM-DD"  id="BEGIN_DATE" type="text"  fieldname="BEGIN_DATE" name = "BEGIN_DATE"   /></td>
  </tr>
  <tr>
    <td width="568" colspan="4" ><p align="center">
       ...
       <label class="checkbox inline"><input type="checkbox" id="ZHONGYAO"  sv="重要人员考勤 ">重要人员考勤 </label>
       <label class="checkbox inline"><input type="checkbox" id="ZHUYAO" sv="主要人员考勤">主要人员考勤</label>
    </p></td>
  </tr>
  <tr>

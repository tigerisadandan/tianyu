...
<html>
	...
	<body onload="doInit()">
		...
		<div class="row-fluid">
			...
			<form id="fileupload"
				action="${pageContext.request.contextPath }/UploadOldServlet"
				...
				<table role="presentation" class="table table-striped" border="2">
	...
	*/
	var controllername= "${pageContext.request.contextPath }/fileUploadOldController";
	$(function() {
	});

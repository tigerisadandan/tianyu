	...
	<head>
		...
		<script type="text/javascript" charset="utf-8">
			...
			function resizeIframe(){
				...
				var showPreviewIframe = document.getElementById("showPreviewFrame");
				showPreviewIframe.style.height = cl+"px";	
				}
			function doInit(){
				...
				if(type.val()=="history"){
					...
					actionUrl = "${pageContext.request.contextPath }/fileUploadController/doPreview?fileid="+fileid;
				} 
				$.ajax({
					url:actionUrl,
					data:"",

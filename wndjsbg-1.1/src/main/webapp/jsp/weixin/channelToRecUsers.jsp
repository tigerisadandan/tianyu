  ...
  <div class="row-fluid" align="center">
	  ...
	  <h4 class="title" style="width: 260px">
	    <span class="pull-right" >
	    	<button class="btn" id="saveRecUserInfo">保存</button>
		    <button class="btn" id="btnCancel">关闭</button>
	    </span>
	  </h4>
	  <div class="zTreeDemoBackground left" style="height: 280px;">
	    <ul id="recUserTree" class="ztree" style="height: 280px;width: 360px">
...
var setting = {
	...
	async: {
		enable: true,
		url: controllername + "/loadAllRecUsers?CHANNEL_UID="+CHANNEL_UID,
		autoParam: ["id"]
	},
	view: {
...
//点击保存按钮
$(function() {
	var saveRecUserInfoBtn = $("#saveRecUserInfo");
	saveRecUserInfoBtn.click(function() {
		if(CHANNEL_UID==''||CHANNEL_UID==null){
			xInfoMsg("栏目不能为空！");
			return;
		}
	
		var zTree = $.fn.zTree.getZTreeObj("recUserTree");
		// 获取输入框被勾选的节点集合
		...
		var success = defaultJson.doInsertJson("${pageContext.request.contextPath }/wndjsbg/weixin/atRecAuthChannelController?awardToUsers&channelid="+CHANNEL_UID+"&val="+val, null, null);
	});
...
$(document).ready(function() {
	$.fn.zTree.init($("#recUserTree"), setting);
});
</script>

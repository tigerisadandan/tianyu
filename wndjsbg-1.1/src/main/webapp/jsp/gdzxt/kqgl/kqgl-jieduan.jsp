...
<body class="no-skin">
						...
						<div class="widget-box">
								<div class="widget-header">
									<h4 class="lighter blue widget-title">
										<span class="col-xs-6">分阶段考勤记录 </span>
										
										<span class="col-xs-6">
											<span class="pull-right inline">
												<a data-target="" id="detail" data-toggle="modal">
													<button id="btn_detail" class="btn btn-primary btn-sm" type="button">详细</button>
												</a>	
												<a data-target="" id="new" data-toggle="modal">
													<button id="btn_new" class="btn btn-primary btn-sm" type="button">添加</button>
												</a>											
											</span>
										</span>
									</h4>
	...
	<script type="text/javascript" charset="utf-8">
		...
		$('#new').click(function(){
			...
			$.get(contextPath+"/jsp/gdzxt/kqgl/kqgl-jieduan-add.jsp", function(data){
		...
		$('#detail').click(function(){
			...
			$.get(contextPath+"/jsp/gdzxt/kqgl/kqgl-jieduan-detail.jsp", function(data){
				  $("#jsProject-input").html(data);
				 // setStyle($('#xmInfoFrm'));
				 // $('#manyLX').empty();
				 // $("#xmInfoFrm").clearFormResult(); 

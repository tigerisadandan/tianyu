...
var controllername= "${pageContext.request.contextPath }/rygl/laowuContractsController";
				...
				<table class="B-table" width="100%">
					...
					<tr>
						<td class="right-border bottom-border" width="20%">
							 <input type=radio value="30" name="status" onclick="javascript:checkStatus(this)" checked="checked"  >履行中<h id="dsid"></h>&nbsp;&nbsp;
      						 <input type=radio value="10" name="status" onclick="javascript:checkStatus(this)">已终止<h id="ysid"></h>&nbsp;&nbsp;
	            ...
	            <table width="100%" class="table-hover table-activeTd B-table" id="DT1" type="single"  pageNum="18">
	                <thead>
	                	<tr>    
							...
							<th fieldname="CONTRACTS_CODE" colindex=2 tdalign="center" maxlength="30">&nbsp;合同编码&nbsp;</th>
							<th fieldname="LAOWU_CONTRACTS_NAME" colindex=2 tdalign="center" maxlength="30" >&nbsp;合同名称&nbsp;</th>
							<th fieldname="JF" colindex=2 tdalign="center" maxlength="30" >&nbsp;甲方 &nbsp;</th>
							<th fieldname=YF colindex=3 tdalign="center" maxlength="30" >&nbsp;乙方 &nbsp;</th>
							<th fieldname=WORK_PAY colindex=3 tdalign="center" maxlength="30" >&nbsp;在工报酬&nbsp;</th>
							<th fieldname="NO_WORK_PAY" colindex=20 tdalign="center" >&nbsp;待工报酬 &nbsp;</th>
	                	</tr>
	                </thead>
	              	<tbody></tbody>
	           </table>

			...
			<form method="post" id="queryForm">
				<table class="B-table" width="100%">
					...
					<tr>
						...
						<th width="3%" class="right-border bottom-border text-right">项目状态</th>
						<th width="3%" class="right-border bottom-border text-right">是否发卡</th>
	            ...
	            <table width="100%" class="table-hover table-activeTd B-table" id="DT1" type="single"  pageNum="18">
	                <thead>
	                	<tr>
							...
							<th fieldname="PERSON_NAME" colindex=2 tdalign="center" maxlength="30">&nbsp;信息卡&nbsp;</th>
							<th fieldname="SHENFENZHENG" colindex=2 tdalign="center" maxlength="30" >&nbsp;项目名称&nbsp;</th>
							<th fieldname="SHENFENZHENG" colindex=2 tdalign="center" maxlength="30" >&nbsp;工作单位&nbsp;</th>
							<th fieldname=COMPANY_NAME colindex=3 tdalign="center" maxlength="30"> &nbsp;建设单位</th>
							<th fieldname="SGZH" colindex=20 tdalign="center" >&nbsp;籍贯&nbsp;</th>					
	                	</tr>
	                </thead>
	              	<tbody></tbody>
	           </table>

...
function init(){
	...
	$("#DT_RY_BIANGENG_UID").val(tempJson.DT_RY_BIANGENG_UID);
	...
	$.ajax({
		...
		success : function(response) {				
			...
			//加载附件
			queryFileData(resultobj.BB_RY_UID, "", "", "999009");	
		}
	});
...
<div class="row-fluid">
	<div class="B-small-from-table-autoConcise">
     ...
     <form method="post" id="queryForm"  >
    	  <input type="hidden" id="DT_RY_BIANGENG_UID" fieldname="DT_RY_BIANGENG_UID" name = "DT_RY_BIANGENG_UID" operation="="/>
    	  <input type="hidden" id="GONGCHENG_UID" fieldname="v.GONGCHENG_UID" name = "GONGCHENG_UID" operation="="/>

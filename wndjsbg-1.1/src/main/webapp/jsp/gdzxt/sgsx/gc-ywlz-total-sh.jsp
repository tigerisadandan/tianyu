...
function init(){
	 ...
	 $.ajax({
		...
		if(spyw_uid=="117"){
		    spywName="开工前安全条件复查";
		}else if(spyw_uid=="118"){
		    spywName="人脸识别考勤备案";
		}else if(spyw_uid=="119"){
		    spywName="建筑工程施工注册证及安监备案"; 
		
		}else if(spyw_uid=="114"){
	        spywName="施工申报";
		}else{
		    spywName="市政工程申报";
		}
		$("#ywlzmcid").html("-"+spywName);
		//列出审批意见信息
...
<div class="row-fluid">  
	<div class="B-small-from-table-autoConcise">
       <h4 class="title"><span id="ywlzmcid">审批</span>

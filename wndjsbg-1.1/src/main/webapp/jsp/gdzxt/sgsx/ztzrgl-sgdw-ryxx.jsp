...
function doProQuery(){
	...
	//调用ajax插入	
	defaultJson.doQueryJsonList(controllername+"?querySGRY",data,DT1);
}
...
function rowView(index){
	if($("#DT1").getSelectedRowIndex()==-1)
     ...
     $(window).manhuaDialog({"title":"人员详细信息查询","type":"text","content":"${pageContext.request.contextPath }/jsp/gdzxt/sgsx/ztzrgl-ryxx-detail.jsp?PERSON_UID="+PERSON_UID+"&personType=SGRY","modal":"1"});
}
</script>      
</head>
<body>
				...
				<table class="B-table" width="100%" id="condition">
					...
					<tr style="display: none;">
						...
						<td class="right-border bottom-border">
							...
							<input type="text" class="span12" kind="text" id="COM_TYPE" fieldname="V.COM_TYPE" operation="=" value="SG"/>
						</td>
					</tr>

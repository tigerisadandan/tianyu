...
function rowSh(obj){
	...
	$(window).manhuaDialog({"title":"现场人员管理>人员变更审核","type":"text","content":"${pageContext.request.contextPath }/jsp/gdzxt/index/rybiangeng-sh.jsp?bguid="+bguid+"&gcuid="+gcuid,"modal":"2"});
}

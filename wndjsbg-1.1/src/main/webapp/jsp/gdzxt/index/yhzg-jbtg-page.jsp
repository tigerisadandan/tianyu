...
function rowSh(obj){
	...
	$(window).manhuaDialog({"title":"隐患整改>局部停工审核","type":"text","content":"${pageContext.request.contextPath }/jsp/gdzxt/index/yhzg-jbtg-sh.jsp?tzdUid="+tzdUid,"modal":"2"});
}
				...
				<table class="B-table" width="100%">
					...
					<TR style="display: none;">
						...
						<TD class="right-border bottom-border">
							...
							<INPUT type="hidden" class="span12"   fieldname="tzd.ZG_XINGZHI_UID" operation="=" value="2"/>
						</TD>
					</TR>
					<!--可以再此处加入hidden域作为过滤条件 -->
					<tr>

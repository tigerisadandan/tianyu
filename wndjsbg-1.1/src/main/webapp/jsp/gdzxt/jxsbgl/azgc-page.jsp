...
$(function() {
	...
	$("#btnQuery").click(function() {
		...
		//调用ajax插入
		defaultJson.doQueryJsonList(controllername+"?queryAzgc",data,DT1);
	});
	//按钮绑定事件(新增)
...
function dayin(obj) { //打印
	var html = "";
	html +="<span class='btn btn-link' id='addSpan' onclick=\"doprint('"+obj.JXSB_AZGC_UID+"');\">";
...
function doprint(id){
	window.open("${pageContext.request.contextPath }/jsp/gdzxt/jxsbgl/azgc-print.jsp?id="+id+"&gcid="+$("#gcuid").val(),"",
					...
					<table class="B-table" width="100%">
						...
						<tr>
							...
							<td class="right-border bottom-border" width="15%">
							 <input class="span12" type="text" id="CQ_BH" name="g.CQ_BH" fieldname="g.CQ_BH" operation="like" >
							</td>
						...
						<thead>
							<tr>
								...
								<!-- <th CustomFunction="caozuoFun" fieldname="JXSB_AZGC_UID"
									...
									<th CustomFunction="dayin" fieldname="JXSB_AZGC_UID" style="width:25px"
								...
								<th fieldname=SBAZ_DATE colindex=3 tdalign="center" maxlength="30">&nbsp;安装开始日期
									&nbsp;</th>
								<th fieldname="SBAZ_E_DATE" colindex=20 tdalign="center">&nbsp;安装结束日期&nbsp;</th>
								<th fieldname="BJJC" colindex=20 tdalign="center">&nbsp;零部件检查验收表&nbsp;</th>

...
$(function() {
	...
	$("#btnQuery").click(function() {
		...
		//调用ajax插入
		defaultJson.doQueryJsonList(controllername+"?queryJcys",data,DT1);
	});
	//按钮绑定事件(新增)
...
function dayin(obj) { //打印
	var html = "";
	html +="<span class='btn btn-link' id='addSpan' onclick=\"doprint('"+obj.JXSB_JCYS_HIS_UID+"');\">";
...
function doprint(id){
	window.open("${pageContext.request.contextPath }/jsp/gdzxt/jxsbgl/jcys-print.jsp?id="+id+"&gcid="+$("#gcuid").val(),"",
						...
						<thead>
							<tr>
								<th name="XH" id="_XH" style="width:10px" colindex=1
									tdalign="center">&nbsp;#&nbsp;</th>
								<!-- <th CustomFunction="caozuoFun" fieldname="JXSB_JCYS_HIS_UID"
									colindex=0 tdalign="center">&nbsp;&nbsp;</th>-->
<th CustomFunction="dayin" fieldname="JXSB_JCYS_HIS_UID" style="width:25px"
								...
								<th fieldname=JC_DW colindex=3 tdalign="center" maxlength="30">&nbsp;检测单位
									&nbsp;</th>
								<th fieldname="JCBG_BH" colindex=20 tdalign="center">&nbsp;检测报告编号&nbsp;</th>
								<th fieldname="JC_DATE" colindex=20 tdalign="center">&nbsp;检测日期&nbsp;</th>
								<th fieldname="SYDJ_END_DATE" colindex=20 tdalign="center">&nbsp;使用证办理截至日期&nbsp;</th>
							</tr>
						</thead>
						<tbody></tbody>
					</table>

					...
					<div class="page-header">
						...
						<div class="col-xs-12">
							...
							<form role="form" class="form-horizontal" id="queryForm">
								<div class="form-group">
									<div class="col-xs-9">
										<label class="control-label no-padding-left" for="userName">产权编号</label>
										<input class="control-label" style="width:100px;" name="LIXIANG_NAME" fieldname="LIXIANG_NAME" id="LIXIANG_NAME"  operation="like" logic="and" >
										<input class="hidden" id="rownum" type="text" fieldname="rownum"  value="10000" operation="  &lt;= "/>
										<label class="control-label no-padding-left" for="userName">规格型号</label>
										<input class="control-label" style="width:100px;" name="LIXIANG_NAME" fieldname="LIXIANG_NAME" id="LIXIANG_NAME"  operation="like" logic="and" >
										<label class="control-label no-padding-left" for="userName">使用登记编号</label>
										<input class="control-label" style="width:100px;" name="LIXIANG_NAME" fieldname="LIXIANG_NAME" id="LIXIANG_NAME"  operation="like" logic="and" >
									</div>
									<div class="col-xs-3">

...
function dayin(obj) { //打印
	var html = "";
	html +="<span class='btn btn-link' id='addSpan' onclick=\"doprint('"+obj.JXSB_AZGZ_UID+"');\">";
...
function doprint(id){
	window.open("${pageContext.request.contextPath }/jsp/gdzxt/jxsbgl/azgz-print.jsp?id="+id+"&gcid="+$("#gcuid").val(),"",
					...
					<table class="B-table" width="100%">
						...
						<TR style="display: none;">
							...
							<TD class="right-border bottom-border"><INPUT type="text"
								...
								id="gcuid" fieldname="s.GONGCHENG_UID" operation="=" /></TD>
						</TR>
						<!--可以再此处加入hidden域作为过滤条件 -->
						<tr>
							...
							<td class="right-border bottom-border" width="12%"><select
								...
								fieldname="s.SHEBEI_NAME" class="col-xs-10 col-sm-10"
								operation="=">
						...
						<thead>
							<tr>
								<th name="XH" id="_XH" style="width:10px" colindex=1 
									tdalign="center">&nbsp;#&nbsp;</th>
								<th CustomFunction="caozuoFun" fieldname="JXSB_AZGZ_UID" style="width:25px"
									colindex=0 tdalign="center">&nbsp;&nbsp;</th>
								<th CustomFunction="dayin" fieldname="JXSB_AZGZ_UID" style="width:25px"
									colindex=0 tdalign="center">&nbsp;打印&nbsp;</th>
								<th CustomFunction="shzt" fieldname="STATUS" colindex=2
									tdalign="center" hidden maxlength="30">&nbsp;审核状态&nbsp;</th>
								<th CustomFunction="shzt" fieldname="SHENHE_STATUS" colindex=2
									tdalign="center" maxlength="30">&nbsp;审核状态 &nbsp;</th>
								<th fieldname=JXSB_TYPE_UID_SV colindex=3 tdalign="center"
									maxlength="30">&nbsp;设备名称&nbsp;</th>
								<th fieldname=CQBH colindex=3 tdalign="center" maxlength="30">&nbsp;产权编号
									&nbsp;</th>

				...
				<table id="apex_layout_84945431230501312" class="formlayout" summary="">
					<tbody>
						<tr>
							...
							<td colspan="1" rowspan="1" align="center"><span id="P6052_BT">附件二： <font style="font-size:15pt;">无锡市新区建筑施工起重机械设备安装告知表</font><br>
								<br>
							</span>
							</td>
						</tr>
...
.formtd {
				...
				<tbody>
					...
					<tr class="t3Body">
						...
						<table id="apex_layout_84944805573501306" class="formlayout" summary="">
								<tbody>
									<tr>
										<td align="center" style="width:120px" ><label for="P6052_SHEBEI_NAME"><span class="t3Optional">设备名称</span>
										</label>
										</td>
										<td colspan="1" rowspan="1" align="left" style="width:240px" fieldname="SHEBEI_NAME">
										</td>
										<td align="center" style="width:120px" ><label for="P6052_XKZHAO"><span class="t3Optional">制造许可证号</span>
										</label>
										</td>
										<td colspan="1" rowspan="1" align="left" fieldname="XKZHAO"  style="width:270px" >
										</td>
									</tr>
									<tr>
										...
										<td colspan="1" rowspan="1" align="left" fieldname="ZZCJ">
										</td>
										<td align="center"><label for="P6052_GGXH"><span class="t3Optional">规格型号（含起重量）</span>
										</label>
										</td>
										<td colspan="1" rowspan="1" align="left" fieldname="GGXH">
										</td>
									</tr>
									<tr>
										<td nowrap="nowrap" align="center"><label for="P6052_HGZH"><span class="t3Optional">产品合格证号</span>
										</label>
										</td>
										<td colspan="1" rowspan="1" align="left" fieldname="HGZH" >
										</td>
										<td align="center"><label for="P6052_CHUCHANG_DATE"><span class="t3Optional">出厂日期</span>
										</label>
										</td>
										<td colspan="1" rowspan="1" align="left" fieldname="CHUCHANG_DATE">
										</td>
									</tr>
									<tr>
										<td nowrap="nowrap" align="center"><label for="P6052_CQ_DANWEI"><span class="t3Optional">设备产权单位</span>
										</label>
										</td>
										<td colspan="1" rowspan="1" align="left" fieldname="CQ_DANWEI">
										</td>
										<td align="center"><label for="P6052_CQ_BH"><span class="t3Optional">产权编号</span>
										</label>
										</td>
										<td colspan="1" rowspan="1" align="left" fieldname="CQ_BH">
										</td>
									</tr>
									<tr>
										<td nowrap="nowrap" align="center"><label for="P6052_ZCBY_DANWEI"><span class="t3Optional">转场保养单位</span>
										</label>
										</td>
										<td colspan="1" rowspan="1" align="left" fieldname="ZCBY_DANWEI">
										</td>
										<td nowrap="nowrap" align="center"><label for="P6052_XYSC_CODE"><span class="t3Optional">无锡市信用手册编号</span>
										</label>
										</td>
										<td colspan="1" rowspan="1" align="left" fieldname="XYSC_CODE">
										</td>
									</tr>
									<tr>
										<td nowrap="nowrap" rowspan="2" align="center"><label for="P6052_AZ_DANWEI"><span class="t3Optional">设备安装单位</span>
										</label>
										</td>
										<td colspan="1" rowspan="2" align="left" fieldname="AZ_DANWEI">
										</td>
										<td nowrap="nowrap" align="center"><label for="P6052_ZYJSREN"><span class="t3Optional">安装现场专业技术人员</span>
										</label>
										</td>
									...
									<tr>
										<td nowrap="nowrap" align="center"><label for="P6052_ZZAQ"><span class="t3Optional">安装现场专职安全员</span>
										</label>
										</td>
									...
									<tr>
										<td nowrap="nowrap" style="border-bottom:none;" align="center"><label for="P6052_SBAZ_DATE"><span class="t3Optional">设备拟安装日期</span>
										</label>
										</td>
										<td colspan="1" rowspan="1" align="left"  fieldname="SBAZ_DATE">从
										</td>
										<td align="center"><label for="P6052_AZZJ_DATE"><span class="t3Optional">安装自检日期</span>
										</label>
										</td>
										<td colspan="1" rowspan="1" align="left" fieldname="AZZJ_DATE">
										</td>
									</tr>
									<tr>
										<td nowrap="nowrap" style="border-top:none;" align="center"><label for="P6052_SBAZ_E_DATE"><span class="t3Optional"></span>
										</label>
										</td>
										<td colspan="1" rowspan="1" align="left" fieldname="SBAZ_E_DATE">至
										</td>
										<td align="center"><label for="P6052_AZYS_DATE"><span class="t3Optional">安装验收日期</span>
										</label>
										</td>
										<td colspan="1" rowspan="1" align="left"  fieldname="AZYS_DATE">
										</td>
									</tr>
									<tr>
										<td align="center"><label for="P6052_YS_DATE"><span class="t3Optional">工程名称</span>
										</label>
										</td>
										<td colspan="1" rowspan="1" align="left" id="GONGCHENG_NAME" fieldname="GC_NAME">
										</td>
										<td align="center"><label for="P6052_GCH_ADDRESS"><span class="t3Optional">工程地点</span>
										</label> 
										</td>
										<td colspan="1" rowspan="1" align="left" id="GC_ADDRESS"  fieldname="GC_ADDRESS">
										</td>
									</tr>
									<tr>
										<td align="center"><label for="P6052_GCSG_DANWEI"><span class="t3Optional">工程施工单位</span>
										</label>
										</td>
										<td colspan="1" rowspan="1" align="left" id="COMPANY_NAME"  fieldname="GCSG_DANWEI">
										</td>
										<td nowrap="nowrap" align="center"><label for="P6052_XMJL"><span class="t3Optional">使用单位项目经理</span>
										</label>
										</td>
										<td colspan="1" rowspan="1" align="left" id="XMJL" fieldname="XMJL" >
										</td>
									</tr>
									<tr>
							...
							<table class="formlayout" id="P6052_BK2" summary="">
								<tbody>
									...
									<tr>
										...
										<textarea fieldname="AQGL_REN" name = "AQGL_REN" rows="5" cols="80" wrap="virtual" id="P6052_AQGL_REN" style="width:180px;" readonly="true"></textarea>
										</td>
									</tr>
									<tr>
										...
										<td style="border-left:none;border-top:none;" colspan="1" rowspan="1" align="left"><span id="CREATED_DATE"></span>
										</td>
									</tr>
									<tr>
										...
										<textarea fieldname="JL_SHENHE_YJ" name = "JL_SHENHE_YJ" rows="5" cols="100" wrap="virtual" id="P6052_JL_SHENHE_YJ" style="width:595px;" readonly="true">test</textarea>
										</td>
									</tr>
									<tr>
									...
									<tr>
										...
										<textarea fieldname="GZ_SHOULI_YJ" name = "GZ_SHOULI_YJ"  rows="5" cols="80" wrap="virtual" id="P6052_GZ_SHOULI_YJ" style="width:595px;" readonly="true"></textarea>
										</td>
									</tr>
	...
	$(document).ready(function(){
	 ...
	 $("#btnSave").click(function(){
		 window.location.href = "${pageContext.request.contextPath }/bzwj/jxsbAzgzController/download?uid="+<%=id %>;
	...
	$.ajax({
		url : "${pageContext.request.contextPath }/bzwj/jxsbAzgzController/queryByView",
		data : data,
		cache : false,
		async : false,
		dataType : "json",
...
$
		.ajax({ 
			url : "${pageContext.request.contextPath }/bzwj/jxsbAzgzController/queryAzyr",
			data : data,
			cache : false,
			async : false,
			dataType : "json",
			...
			success : function(response) {
				if (response.msg != '0') {
					...
					for ( var i = 0; i < resultmsgobj.response.data.length; i++) {
						...
						"	<td nowrap='' style='border-right:none;' align='center'><span class='t3NoLabel'></span>"+
						"	</td>"+
						"	<td style='border-left:none;width:240px' colspan='1' rowspan='1' align='center'>"+obj[i].JOB_TYPE+
						"	</td>"+
						"	<td nowrap='' style='border-right:none;' align='right'><span class='t3NoLabel'></span>"+
						"	</td>"+
						"	<td style='border-left:none;width:220px' colspan='1' rowspan='1' align='center'>"+obj[i].ZGBH+
						"	</td>"+
						"	<td nowrap='' style='border-right:none;' align='center'><span class='t3NoLabel'></span>"+
						"	</td>"+
						"	<td style='border-left:none;width:180px' colspan='1' rowspan='1' align='center'>"+obj[i].BEIZHU+
						"	</td>"+
						"</tr>";
					}
					html+="	<tr>"+
				...
				"</tr>"; //清空
					...
					for ( var i = 0; i < resultmsgobj.response.data.length; i++) {
						...
						html +="<tr>"+
							...
							"<td nowrap=\"\" style=\"border-right:none;\" align=\"right\"><span class=\"t3NoLabel\"></span>"+
						    "	</td>"+
							"<td style=\"border-left:none;width:534px\" colspan=\"1\" rowspan=\"1\" align=\"left\"><span id=\"P6052_ZL_NAME1\">"+obj[i].CL_NAME+"</span>"+
							"</td>"+
							"<td nowrap=\"\" style=\"border-right:none;\" align=\"right\"><span class=\"t3NoLabel\"></span>"+
							"</td>"+

...
<form method="post" id="queryForm"  >
	...
	<div class="modal-dialog width-90 height-aoto" style="width: 702px;">
      	<br/>
		<form class="form-horizontal" id="wxysjkform">
		<input type="hidden" id="WXY_SJK_UID" fieldname="WXY_SJK_UID"/>
			<div style="padding:10px;text-align:left;" valign="top">
				<table style="width: 702px;" class="content">
					...
					<tr height="41px">
							...
							<h4><span id="spyjtxhid">项目信息<span id="shstatus" ></span> </span>
								...
								%>
									<button id="btnPrint" class="btn" onclick="print()" type="button" style="font-family:SimYou,Microsoft YaHei;font-weight:bold;">打印</button>
								<%
									}
								%>
	  		<button id="btnSave" class="btn" onclick="col()" type="button" style="font-family:SimYou,Microsoft YaHei;font-weight:bold;">关闭</button>
						...
						<tr>
							...
							<td align="left"><table>
									<tbody>
										<tr>
											<td align="right"><label for="FORM_CODE"><span
										...
										<tr>
											<td align="right"><label for="SG_NAME"><span
													class="t3Optional">总包单位名称</span>
											</label>
											</td>
											<td colspan="1" rowspan="1" align="left"><input
												type="text" fieldname="SG_NAME" readonly="readonly">
											</td>
											<td align="right"><label for="JL_NAME"><span
													class="t3Optional">监理单位名称</span>
											</label>
											</td>
											<td colspan="1" rowspan="1" align="left"><input
												type="text" fieldname="JL_NAME" readonly="readonly">
											</td>
										</tr>
									</tbody>
								</table></td>
					...
					<tbody style="border: 1px;border-color: red">
						...
						<tr>
							...
							<td align="left"><table fieldname="apex_layout_89663626999534478"
									...
									<tbody>
										<tr>
											<td align="right"><label for="KC_NAME"><span
													class="t3Optional">勘察单位及文号</span>
											</label>
											</td>
											<td colspan="1" rowspan="1" align="left"><input
												type="text" fieldname="KC_NAME" class="lwidth"
												readonly="readonly">
											</td>
										</tr>
										<tr>
											<td align="right"><label for="SJK_WEIZHI"><span
													class="t3Optional">深基坑位置</span>
											</label>
											</td>
											<td colspan="1" rowspan="1" align="left"><input
												type="text" fieldname="SJK_WEIZHI" class="lwidth"
												readonly="readonly">
											</td>
											<td align="right"><label for="SJK_SHENDU"><span
													class="t3Optional">基坑最大深度</span>
											</label>
											</td>
											<td colspan="1" rowspan="1" align="left"><input
												type="text" fieldname="SJK_SHENDU" class="lwidth"
												readonly="readonly">
											</td>
										</tr>
										<tr>
											<td align="right"><label for="SJ_NAME"><span
													class="t3Optional">专项施工<br>方案设计单位</span>
											</label>
											</td>
											<td colspan="1" rowspan="1" align="left"><input
												type="text" fieldname="SJ_NAME" class="lwidth"
												readonly="readonly">
											</td>
										</tr>
										<tr>
											<td nowrap="" align="right"><label for="HR1"><span
													class="t3Optional">专业施工单位</span>
											</label>
											</td>
											<td colspan="3" rowspan="1" align="left"><span
												fieldname="HR1"><hr>
											</span>
											</td>
										</tr>
										<tr>
											<td align="right"><label for="ZYSG_NAME"><span
													class="t3Optional">专业施工<br>单位名称</span>
											</label>
											</td>
											<td colspan="1" rowspan="1" align="left"><input
												type="text" fieldname="ZYSG_NAME" class="lwidth"
												readonly="readonly">
											</td>
											<td align="right"><label for="ZYSG_CODE"><span
													class="t3Optional">资质证书编号</span>
											</label>
											</td>
											<td colspan="1" rowspan="1" align="left"><input
												type="text" fieldname="ZYSG_CODE" class="swidth"
												readonly="readonly">
											</td>
										</tr>
										<tr>
											<td align="right"><label for="ZYSG_SCXKZ"><span
													class="t3Optional">安全生产许可证编号</span>
											</label>
											</td>
											<td colspan="1" rowspan="1" align="left"><input
												type="text" fieldname="ZYSG_SCXKZ" class="swidth"
												readonly="readonly">
											</td>
										</tr>
										<tr>
											<td nowrap="" align="right"><label for="HR"><span
													class="t3Optional">监测单位</span>
											</label>
											</td>
											<td colspan="3" rowspan="1" align="left"><span
												fieldname="HR"><hr>
										...
										<tr>
											<td align="right"><label for="JC_NAME"><span
													class="t3Optional">监测单位名称</span>
											</label>
											</td>
											<td colspan="1" rowspan="1" align="left"><input
												type="text" fieldname="JC_NAME" class="lwidth"
												readonly="readonly">
											</td>
											<td align="right"><label for="JC_CODE"><span
													class="t3Optional">资质证书编号</span>
											</label>
											</td>
											<td colspan="1" rowspan="1" align="left"><input
												type="text" fieldname="JC_CODE" class="swidth"
												readonly="readonly">
											</td>
										</tr>
										<tr>
											<td nowrap="" align="right"><label for="HR3"><span
													class="t3Optional">专家论证</span>
											</label>
											</td>
											<td colspan="3" rowspan="1" align="left"><span
												fieldname="HR3"><hr>
									...
									<tbody>
										...
										<tr>
											<td align="left"><label for="CAILIAO3"><span
													class="t3Optional"> 3、提供专家论证意见文稿及签到名单</span>
											</label>
											</td>
											<td colspan="1" rowspan="1" align="left"><input
										...
										<tr>
											<td align="left"><label for="CAILIAO5"><span
													class="t3Optional"> 5、提供经总包单位、监理单位审批的监测方案</span>
											</label>
											</td>
											<td colspan="1" rowspan="1" align="left"><input
										...
										<tr>
											<td align="left"><label for="CAILIAO6"><span
													class="t3Optional"> 6、专业施工单位、监测单位提供资质证书复印件</span>
											</label>
											</td>
											<td colspan="1" rowspan="1" align="left"><input
												type="hidden" name="p_arg_names" value="89673001023534490">
											<fieldset fieldname="CAILIAO6" class="checkbox_group">
													<input type="checkbox" name="p_v38" value="1"
														disabled="true" fieldname="CAILIAO6"><label
														for="CAILIAO6_0"> </label>
												</fieldset></td>
										</tr>
										<tr>
											<td align="left"><label for="CAILIAO7"><span
													class="t3Optional"> 7、专业施工单位提供安全生产许可证复印件</span>
											</label>
											</td>
											<td colspan="1" rowspan="1" align="left"><input
												type="hidden" name="p_arg_names" value="89671219152534489">
											<fieldset fieldname="CAILIAO7" class="checkbox_group">
													<input type="checkbox" name="p_v39" value="1"
														disabled="true" fieldname="CAILIAO7"><label
														for="CAILIAO7_0"> </label>
												</fieldset></td>
										</tr>
										<tr>
											<td align="left"><label for="CAILIAO8"><span
													class="t3Optional"> 8、专业施工单位的专业技术人员资格证书复印件</span>
											</label>
											</td>
											<td colspan="1" rowspan="1" align="left"><input
												type="hidden" name="p_arg_names" value="89671413158534489">
											<fieldset fieldname="CAILIAO8" class="checkbox_group">
													<input type="checkbox" name="p_v40" value="1"
														disabled="true" fieldname="CAILIAO8"><label
														for="CAILIAO8_0"> </label>
												</fieldset></td>
										</tr>
										<tr>
											<td align="left"><label for="CAILIAO9"><span
													class="t3Optional"> 9、专业施工单位负责现场安全的专职安全生产管理人员考核证书复印件</span>
											</label>
											</td>
											<td colspan="1" rowspan="1" align="left"><input
												type="hidden" name="p_arg_names" value="89668015611534486">
											<fieldset fieldname="CAILIAO9" class="checkbox_group">
													<input type="checkbox" name="p_v41" value="1"
														disabled="true" fieldname="CAILIAO9"><label
														for="CAILIAO9_0"> </label>
												</fieldset></td>
										</tr>
										<tr>
											<td align="left"><label for="CAILIAO10"><span
													class="t3Optional"> 10、专项安全技术交底原件</span>
											</label>
											</td>
											<td colspan="1" rowspan="1" align="left"><input
												type="hidden" name="p_arg_names" value="89668227608534486">
											<fieldset fieldname="CAILIAO10" class="checkbox_group">
													<input type="checkbox" name="p_v42" value="1"
														disabled="true" fieldname="CAILIAO10"><label
														for="CAILIAO10_0"> </label>
												</fieldset></td>
										</tr>
										<tr>
											<td align="left"><label for="CAILIAO11"><span
													class="t3Optional"> 11、专业施工单位与施工总承包单位签订的安全管理协议原件</span>
											</label>
											</td>
											<td colspan="1" rowspan="1" align="left"><input
												type="hidden" name="p_arg_names" value="89668401036534486">
											<fieldset fieldname="CAILIAO11" class="checkbox_group">
													<input type="checkbox" name="p_v43" value="1"
														disabled="true" fieldname="CAILIAO11"><label
														for="CAILIAO11_0"> </label>
												</fieldset></td>
										</tr>
										<tr>
											<td align="left"><label for="CAILIAO12"><span
													class="t3Optional"> 12、专业施工单位与施工总承包单位签订的专业施工合同原件</span>
											</label>
											</td>
											<td colspan="1" rowspan="1" align="left"><input
												type="hidden" name="p_arg_names" value="89668615604534486">
											<fieldset fieldname="CAILIAO12" class="checkbox_group">
													<input type="checkbox" name="p_v44" value="1"
														disabled="true" fieldname="CAILIAO12"><label
														for="CAILIAO12_0"> </label>
												</fieldset></td>
										</tr>
									</tbody>
								</table></td>
...
<div align="center">
	...
	<%=id%>
		...
		function print(){
			...
			window.location.href = "${pageContext.request.contextPath }/wxy/wxySjkController/download?uid="+$("#WXY_SJK_UID").val();
		}
		...
		function query() {
			...
			$.ajax({
				        url : "${pageContext.request.contextPath }/wxy/wxySjkController?query",
						data : data1,
						cache : false,
						async : false,
						dataType : "json",
		...
		function tuihui(){
				...
				$('#ConfirmYesButton').one("click",function(){
					var gcId = $("#GC_UID").val();
					$.ajax({
					url : "${pageContext.request.contextPath }/wxy/wxySjkController?tuiHui",
					data : {"gcId":gcId},
					type : "post",
					success : function(response){
						 window.opener.init();

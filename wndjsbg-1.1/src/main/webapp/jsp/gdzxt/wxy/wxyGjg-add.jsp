...
<form method="post" id="queryForm"  >
	...
	<div class="modal-dialog width-90 height-aoto">
		...
		<input type="hidden" id="WXY_SJK_UID" fieldname="WXY_GJG_UID"/>
			<div style="padding:10px;text-align:left;" valign="top">
				<table style="width: 702px;" class="content">
					...
					<tr height="41px">
							...
							<h4><span id="spyjtxhid">钢结构安装工程<span id="shstatus" ></span> </span>
									...
									<tbody>
										...
										<tr>
											<td align="right"><label for="SG_NAME"><span
													class="t3Optional">钢结构跨度</span>
											</label>
											</td>
											<td colspan="1" rowspan="1" align="left"><input
												type="text" fieldname="GJG_KD" readonly="readonly">
											</td>
											<td align="right"><label for="SG_NAME"><span
...
<div align="center">
	...
	<%=id%>
		...
		function print(){
			window.location.href = "${pageContext.request.contextPath }/wxy/wxyGjgController/download?uid="+$("#WXY_SJK_UID").val();
		}
		...
		function query() {
			...
			$.ajax({
				        url : "${pageContext.request.contextPath }/wxy/wxyGjgController?query",
						data : data1,
						cache : false,
						async : false,
						dataType : "json",
		...
		function tuihui(){
				...
				$('#ConfirmYesButton').one("click",function(){
					var gcId = $("#GC_UID").val();
					$.ajax({
					url : "${pageContext.request.contextPath }/wxy/wxyGjgController?tuiHui",
					data : {"gcId":gcId},
					type : "post",
					success : function(response){
						 window.opener.init();

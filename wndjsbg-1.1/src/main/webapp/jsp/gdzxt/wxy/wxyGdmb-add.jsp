...
<form method="post" id="queryForm"  >
	...
	<div class="modal-dialog width-90 height-aoto">
		...
		<input type="hidden" id="WXY_SJK_UID" fieldname="WXY_GDMB_UID"/>
			<div style="padding:10px;text-align:left;" valign="top">
				<table style="width: 702px;" class="content">
					...
					<tr height="41px">
							...
							<h4><span id="spyjtxhid">高大模板<span id="shstatus" ></span>
	  		...
	  		<button id="btnSave" class="btn" onclick="col()" type="button" style="font-family:SimYou,Microsoft YaHei;font-weight:bold;">关闭</button>
						...
						<tr>
							...
							<td align="left"><table>
									<tbody>
										<tr>
											<td align="right" style="width: 19%"><label for="FORM_CODE"><span
										...
										<tr>
											<td align="right" ><label for="SG_NAME"><span
													class="t3Optional">高大模板部位</span>
											</label>
											</td>
											<td colspan="1" rowspan="1" align="left"  style="width: 25%"><input
												type="text" fieldname="GDMB_BUWEI" readonly="readonly">
											</td>
											<td align="right"  style="width: 15%"><label for="JL_NAME"><span
													class="t3Optional">高大模板高度（跨度、线荷载、集中荷载等）</span>
											</label>
											</td>
											<td colspan="1" rowspan="1" align="left"  style="width: 35%"><input
												type="text" fieldname="GDMB_GD" readonly="readonly">
											</td>
										</tr>
									</tbody>
								</table></td>
				...
				<table style="width: 702px;" class="content">
					<tbody style="border: 1px;border-color: red">
						<tr height="41px">
						<td align="left" colspan="3" class="yw-title">
							<h4><span fieldname="spyjtxhid">时间及专家论证 </span>
								<span class="pull-right"> 
								</span>
								</h4></td>
						</tr>
						<tr>
							...
							<td align="left"><table fieldname="apex_layout_89663626999534478"
									...
									<tbody>
										...
										<tr>
											<td align="right"><label for="PLAN_B_DATE"><span
													class="t3Optional">计划浇筑砼时间</span>
											</label>
											</td>
											<td colspan="1" rowspan="1" align="left"><input
												type="text" fieldname="JZ_DATE" class="datewidth"
												readonly="true">
											</td>
											<td align="right"><label for="PLAN_E_DATE"><span
													class="t3Optional">计划拆模时间</span>
											</label>
											</td>
											<td colspan="1" rowspan="1" align="left"><input
												type="text" fieldname="CM_DATE" class="datewidth"
												readonly="true">
											</td>
										</tr>
										<tr>
									...
									<tbody>
										...
										<tr>
											<td align="left"><label for="CAILIAO3"><span
													class="t3Optional"> 3、提供经总包单位、监理单位审批的专项施工组织设计</span>
											</label>
											</td>
											<td colspan="1" rowspan="1" align="left"><input
										...
										<tr>
											<td align="left"><label for="CAILIAO4"><span
													class="t3Optional"> 4、提供专家论证意见文稿及签到名单</span>
											</label>
											</td>
											<td colspan="1" rowspan="1" align="left"><input
										...
										<tr>
											<td align="left"><label for="CAILIAO5"><span
													class="t3Optional"> 5、提供经总包单位、监理单位审批的实施过程事故应急救援预案</span>
											</label>
											</td>
											<td colspan="1" rowspan="1" align="left"><input
										...
										<tr>
											<td align="left"><label for="CAILIAO6"><span
													class="t3Optional"> 6、专项安全技术交底原件</span>
											</label>
											</td>
											<td colspan="1" rowspan="1" align="left"><input
...
<div align="center">
	...
	<%=id%>
		...
		function print(){
			window.location.href = "${pageContext.request.contextPath }/wxy/wxyGdmbController/download?uid="+$("#WXY_SJK_UID").val();
		}
		...
		function query() {
			...
			$.ajax({
				        url : "${pageContext.request.contextPath }/wxy/wxyGdmbController?query",
						data : data1,
						cache : false,
						async : false,
						dataType : "json",
		...
		function tuihui(){
				...
				$('#ConfirmYesButton').one("click",function(){
					var gcId = $("#GC_UID").val();
					$.ajax({
					url : "${pageContext.request.contextPath }/wxy/wxyGdmbController?tuiHui",
					data : {"gcId":gcId},
					type : "post",
					success : function(response){
						 window.opener.init();

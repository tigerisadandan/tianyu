...
<input id="TFKW_WXY_TYPE" type="hidden"  fieldname="WXY_TYPE" name="WXY_TYPE" value="3">
...
<table border="1" width="100%" cellpadding="0" cellspacing="0" class="content">
			<tr>
				<td class="yw-title">
					<h4 ><span id="spyjtxhid">浇筑前验收<span id="tfkwmsg" style="color: red;"></span></span>
			...
			<tr>
				<th width="15%" class="right-border bottom-border text-right">预计浇筑时间</th>
				<td class="right-border bottom-border">
					<input class="span12" style="width:94%"  type="text" readonly="readonly" fieldname="YUJI_DATE" name="YUJI_DATE"  />			
				</td>
			</tr>
      		<tr>
				<th width="15%" class="right-border bottom-border text-right">水平剪刀撑是否满足方案要求</th>
				<td class="right-border bottom-border">
					<input class="span12" style="width:94%"  type="radio" readonly="readonly" fieldname="SHUIPING_JIANDAO_Y" name="SHUIPING_JIANDAO_Y" kind="dic" src="SF" />			
				</td>
				<th width="15%" class="right-border bottom-border text-right">竖向剪刀撑是否满足方案要求</th>
				<td class="right-border bottom-border">
					<input class="span12" style="width:94%"  type="radio" readonly="readonly" fieldname="SHUXIANG_JIANDAO_Y" name="SHUXIANG_JIANDAO_Y" kind="dic" src="SF" />			
				</td>
			</tr>
			<tr>
				<th width="15%" class="right-border bottom-border text-right">扣件紧固情况</th>
				<td class="right-border bottom-border" colspan="3">
					 <textarea rows="" class="span12" style="width:98%" id="KOUJIAN_JINGGU" readonly="readonly" fieldname="KOUJIAN_JINGGU" name = "KOUJIAN_JINGGU"></textarea>			
				</td>
				
			</tr>
			<tr>
				<th width="15%" class="right-border bottom-border text-right">高支模书面验收情况</th>

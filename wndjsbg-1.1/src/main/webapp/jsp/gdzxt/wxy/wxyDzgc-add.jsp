...
<form method="post" id="queryForm"  >
	...
	<div class="modal-dialog width-90 height-aoto">
		...
		<input type="hidden" id="WXY_SJK_UID" fieldname="WXY_DZGC_UID"/>
			<div style="padding:10px;text-align:left;" valign="top">
				<table style="width: 702px;" class="content">
					...
					<tr height="41px">
							...
							<h4><span id="spyjtxhid">吊装工程<span id="shstatus" ></span> </span>
									...
									<tbody>
										...
										<tr>
											<td align="right"><label for="SG_NAME"><span
													class="t3Optional">吊装部位</span>
											</label>
											</td>
											<td colspan="1" rowspan="1" align="left"><input
												type="text" fieldname="DZ_BUWEI" readonly="readonly">
											</td>
											<td align="right"><label for="JL_NAME"><span
													class="t3Optional">起吊最大重量</span>
											</label>
											</td>
											<td colspan="1" rowspan="1" align="left"><input
												type="text" fieldname="QD_ZL" readonly="readonly">
											</td>
										</tr>
										<tr>
											<td align="right"><label for="SG_NAME"><span
													class="t3Optional">吊装最大高度</span>
											</label>
											</td>
											<td colspan="1" rowspan="1" align="left"><input
												type="text" fieldname="DZ_GD" readonly="readonly">
											</td>
											<td align="right"><label for="JL_NAME"><span
													class="t3Optional">吊车牌号</span>
											</label>
											</td>
											<td colspan="1" rowspan="1" align="left"><input
												type="text" fieldname="DCPH" readonly="readonly">
											</td>
										</tr>
										<tr>
											<td align="right"><label for="SG_NAME"><span
													class="t3Optional">吊车规格型号</span>
											</label>
											</td>
											<td colspan="1" rowspan="1" align="left"><input
												type="text" fieldname="GGXH" readonly="readonly">
											</td>
											<td align="right"><label for="JL_NAME"><span
													class="t3Optional">起重机构年检合格报告编号</span>
											</label>
											</td>
											<td colspan="1" rowspan="1" align="left"><input
												type="text" fieldname="JC_CODE" readonly="readonly">
											</td>
										</tr>
									</tbody>
								</table></td>
									...
									<tbody>
										...
										<tr>
											<td align="right"><label for="PLAN_B_DATE"><span
													class="t3Optional">专业施工单位名称</span>
											</label>
											</td>
											<td colspan="1" rowspan="1" align="left"><input
												type="text" fieldname="SG_NAME" class="datewidth"
												readonly="true">
											</td>
											...
											<td colspan="1" rowspan="1" align="left"><input
												type="text" fieldname="SG_CODE" class="datewidth"
												readonly="true">
											</td>
										</tr>
										<tr>
											...
											<td colspan="1" rowspan="1" align="left"><input
												type="text" fieldname="SCXKZ" class="lwidth"
												readonly="readonly">
											</td>
									...
									<tbody>
										...
										<tr>
											<td align="left"><label for="CAILIAO5"><span
													class="t3Optional"> 5、专业施工单位提供资质证书复印件</span>
											</label>
											</td>
											<td colspan="1" rowspan="1" align="left"><input
										...
										<tr>
											<td align="left"><label for="CAILIAO6"><span
													class="t3Optional"> 6、专业施工单位提供安全生产许可证复印件</span>
											</label>
											</td>
											<td colspan="1" rowspan="1" align="left"><input
										...
										<tr>
											<td align="left"><label for="CAILIAO7"><span
													class="t3Optional"> 7、专业施工单位的专业技术人员资格证书复印件</span>
											</label>
											</td>
											<td colspan="1" rowspan="1" align="left"><input
										...
										<tr>
											<td align="left"><label for="CAILIAO8"><span
													class="t3Optional"> 8、专业施工单位负责现场安全的专职安全生产管理人员考核证书复印件</span>
											</label>
											</td>
											<td colspan="1" rowspan="1" align="left"><input
										...
										<tr>
											<td align="left"><label for="CAILIAO9"><span
													class="t3Optional"> 9、专项安全技术交底原件</span>
											</label>
											</td>
											<td colspan="1" rowspan="1" align="left"><input
										...
										<tr>
											<td align="left"><label for="CAILIAO10"><span
													class="t3Optional"> 10、专业施工单位与施工总承包单位签订的安全管理协议原件</span>
											</label>
											</td>
											<td colspan="1" rowspan="1" align="left"><input
										...
										<tr>
											<td align="left"><label for="CAILIAO11"><span
													class="t3Optional"> 11、专专业施工单位与施工总承包单位签订的专业施工合同原件</span>
											</label>
											</td>
											<td colspan="1" rowspan="1" align="left"><input
...
<div align="center">
	...
	<%=id%>
		...
		function print(){
			window.location.href = "${pageContext.request.contextPath }/wxy/wxyDzgcController/download?uid="+$("#WXY_SJK_UID").val();
		}
		...
		function query() {
			...
			$.ajax({
				        url : "${pageContext.request.contextPath }/wxy/wxyDzgcController?query",
						data : data1,
						cache : false,
						async : false,
						dataType : "json",
		...
		function tuihui(){
				...
				$('#ConfirmYesButton').one("click",function(){
					var gcId = $("#GC_UID").val();
					$.ajax({
					url : "${pageContext.request.contextPath }/wxy/wxyDzgcController?tuiHui",
					data : {"gcId":gcId},
					type : "post",
					success : function(response){
						 window.opener.init();

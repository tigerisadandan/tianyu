...
<input id="TFKW_WXY_TYPE" type="hidden"  fieldname="WXY_TYPE" name="WXY_TYPE" value="4">
...
<table border="1" width="100%" cellpadding="0" cellspacing="0" class="content">
			<tr>
				<td class="yw-title">
					<h4 ><span id="spyjtxhid">拆模<span id="tfkwmsg" style="color: red;"></span></span>
			...
			<tr>
				<th width="15%" class="right-border bottom-border text-right">拆模完成时间</th>
			...
			<tr>
				<th width="15%" class="right-border bottom-border text-right">有可靠立足点实施情况</th>
				<td class="right-border bottom-border" colspan="3">
					 <textarea rows="" class="span12" style="width:98%" id="LIZUDIAN_QINGKUANG" readonly="readonly" fieldname="LIZUDIAN_QINGKUANG" name = "LIZUDIAN_QINGKUANG"></textarea>			
				</td>
				
			</tr>
			<tr>
				<th width="15%" class="right-border bottom-border text-right">区域内临边、洞口防护措施实施情况</th>
				<td colspan="3" class="right-border bottom-border">
				    <textarea rows="" class="span12" style="width:98%" id="LINGBIAN_DONGKOU_QINGKUANG" readonly="readonly" fieldname="LINGBIAN_DONGKOU_QINGKUANG" name = "LINGBIAN_DONGKOU_QINGKUANG"></textarea>
				</td>
			</tr>
			
			<tr>
				<th width="15%" class="right-border bottom-border text-right">拆模设警戒区域专人监护</th>
				<td class="right-border bottom-border" colspan="3">
					 <textarea rows="" class="span12" style="width:98%" id="JINGJIE_JIANHU" readonly="readonly" fieldname="JINGJIE_JIANHU" name = "JINGJIE_JIANHU"></textarea>			
				</td>
			</tr>
	        </table>
					</ul>

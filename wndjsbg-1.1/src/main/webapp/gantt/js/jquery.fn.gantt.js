...
(function ($) {
    ...
    $.fn.gantt = function (options) {
        ...
        var core = {
            ...
            // the entire chart
            createProgressBar: function (days, id, cls, desc, label, dataObj,nullType,fromDate,toDate) {
                var cellWidth = tools.getCellSize();
                var barMarg = tools.getProgressBarMargin() || 0;
                var barId = id ? ' id="' + id + '"' : "";
                var bar = null;
                var fromlessto = false;//开始小于结束
                if(days<0){
                	days = -days;
                	days = days+2
                	fromlessto = true;
                ...
                var title_html = "";
                if(fromlessto==true){
                	title_html = "title = '延期"+(days-1)+"'";
                }else{
                	title_html = "title = '"+(days-1)+"'";
                }
                
                if(days==1){//计划日期等于实际日期
                	 if(nullType==""||nullType==null){
                	   bar = $('<div class="bar" ' + barId + '><div class="con"><div class="dateStart">'+toDate+'</div><div class="gtStartX2"><image src="/wndjsbg/gantt/img/gtStart.png"></image><image src="/wndjsbg/gantt/img/gtEnd.png"></image></div></div></div>');
                	 }else if(nullType=="from"){
                	   bar = $('<div class="bar" ' + barId + '><div class="con"><div class="dateStart">'+toDate+'</div><div class="gtStartX2"><image src="/wndjsbg/gantt/img/gtStart-h.png"></image><image src="/wndjsbg/gantt/img/gtEnd.png"></image></div></div></div>');
                	 }else if(nullType=="all"){
                	   bar = $('<div class="bar" ' + barId + '><div class="con"><div class="dateStart">'+toDate+'</div><div class="gtStartX2"><image src="/wndjsbg/gantt/img/gtStart-h.png"></image><image src="/wndjsbg/gantt/img/gtEnd-h.png"></image></div></div></div>'); 
                	 }else if(nullType=="to"){
                	   bar = $('<div class="bar" ' + barId + '><div class="con"><div class="dateStart">'+toDate+'</div><div class="gtStartX2"><image src="/wndjsbg/gantt/img/gtStart.png"></image><image src="/wndjsbg/gantt/img/gtEnd-h.png"></image></div></div></div>'); 
                	 }
                }else{
                	if(fromlessto == false){
                		if(nullType==""||nullType==null){
                       		bar = $('<div '+title_html+' class="bar" ' + barId + '><div class="con"><div class="dateStart">'+fromDate+'</div><div class="dateEnd">'+toDate+'</div><div class="gtStart"><img src="/wndjsbg/gantt/img/gtStart.png"></div><div class="gtEnd"><img src="/wndjsbg/gantt/img/gtEnd.png"></div><div class="fn-label">' + label + '</div></div></div>')
                     	 }else if(nullType=="from"){
                        	bar = $('<div '+title_html+' class="bar" ' + barId + '><div class="con"><div class="dateStart">'+fromDate+'</div><div class="dateEnd">'+toDate+'</div><div class="gtStart"><img src="/wndjsbg/gantt/img/gtStart-h.png"></div><div class="gtEnd"><img src="/wndjsbg/gantt/img/gtEnd.png"></div><div class="fn-label">' + label + '</div></div></div>')
                     	 }else if(nullType=="all"){
                        	bar = $('<div '+title_html+' class="bar" ' + barId + '><div class="con"><div class="dateStart">'+fromDate+'</div><div class="dateEnd">'+toDate+'</div><div class="gtStart"><img src="/wndjsbg/gantt/img/gtStart-h.png"></div><div class="gtEnd"><img src="/wndjsbg/gantt/img/gtEnd-h.png"></div><div class="fn-label">' + label + '</div></div></div>')
                     	 }else if(nullType=="to"){
                        	bar = $('<div '+title_html+' class="bar" ' + barId + '><div class="con"><div class="dateStart">'+fromDate+'</div><div class="dateEnd">'+toDate+'</div><div class="gtStart"><img src="/wndjsbg/gantt/img/gtStart.png"></div><div class="gtEnd"><img src="/wndjsbg/gantt/img/gtEnd-h.png"></div><div class="fn-label">' + label + '</div></div></div>')
                     	 }
                		
                 	}else{
                 		if(nullType==""||nullType==null){
                       		bar = $('<div '+title_html+' class="bar" ' + barId + '><div class="con"><div class="dateStart">'+toDate+'</div><div class="dateEnd">'+fromDate+'</div><div class="gtStart"><img src="/wndjsbg/gantt/img/gtEnd.png"></div><div class="gtEnd"><img src="/wndjsbg/gantt/img/gtStart.png"></div><div class="fn-label">' + label + '</div></div></div>')
                     	 }else if(nullType=="from"){
                        	bar = $('<div '+title_html+' class="bar" ' + barId + '><div class="con"><div class="dateStart">'+toDate+'</div><div class="dateEnd">'+fromDate+'</div><div class="gtStart"><img src="/wndjsbg/gantt/img/gtEnd.png"></div><div class="gtEnd"><img src="/wndjsbg/gantt/img/gtStart-h.png"></div><div class="fn-label">' + label + '</div></div></div>')
                     	 }else if(nullType=="all"){
                        	bar = $('<div '+title_html+' class="bar" ' + barId + '><div class="con"><div class="dateStart">'+toDate+'</div><div class="dateEnd">'+fromDate+'</div><div class="gtStart"><img src="/wndjsbg/gantt/img/gtEnd-h.png"></div><div class="gtEnd"><img src="/wndjsbg/gantt/img/gtStart-h.png"></div><div class="fn-label">' + label + '</div></div></div>')
                     	 }else if(nullType=="to"){
                        	bar = $('<div '+title_html+' class="bar" ' + barId + '><div class="con"><div class="dateStart">'+toDate+'</div><div class="dateEnd">'+fromDate+'</div><div class="gtStart"><img src="/wndjsbg/gantt/img/gtEnd-h.png"></div><div class="gtEnd"><img src="/wndjsbg/gantt/img/gtStart.png"></div><div class="fn-label">' + label + '</div></div></div>')
                     	 }
                	}
                ...
                bar.hover(function (e) {
                    e.stopPropagation();
                    settings.onItemHover($(this).data("dataObj"));
                });
                return bar;
            },
                            ...
                            switch (settings.scale) {
                                ...
                                case "hours":
                                    ...
                                    _bar = core.createProgressBar(
                                                ...
                                                day.nullType ? day.nullType : null
                                            );
                                ...
                                case "weeks":
                                    ...
                                    _bar = core.createProgressBar(
                                             ...
                                             day.dataObj ? day.dataObj : null,
                                             day.nullType ? day.nullType : null,
                                             (dtFrom.getMonth()+1)+"."+(dtFrom.getDate()+1),
                                             (dtTo.getMonth()+1)+"."+(dtTo.getDate()+1)
                                    ...
                                    _bar.css({ 'margin-top': top+8, 'margin-left': Math.floor(left_) });
                                ...
                                default:
                                    ...
                                    _bar.css({ 'margin-top': top+8, 'margin-left': Math.floor(cFrom) });

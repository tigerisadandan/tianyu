!function($){
  ...
  * ================================= */
  ...
  , setValue:function(item){
		return {"data-value":item.toString(),"code":item.toString()};
    }
  
  , select: function () {
      var val = this.$menu.find('.active').attr('data-value')
	  var realVal = this.$menu.find('.active').attr('code')
      this.$element
        .val(this.updater(val)).attr("code",realVal)
        .change()
      return this.hide()
    }

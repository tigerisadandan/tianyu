...
public interface BgRoleService {
	...
	public abstract String queryRole(String json, User user) throws SQLException;

	public abstract String executeRole(String json, User user, String operatorSign) throws Exception;

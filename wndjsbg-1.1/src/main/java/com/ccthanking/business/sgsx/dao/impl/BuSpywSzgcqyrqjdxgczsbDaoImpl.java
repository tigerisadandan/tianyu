...
@Component
public class BuSpywSzgcqyrqjdxgczsbDaoImpl  extends BsBaseDaoTJdbc implements BuSpywSzgcqyrqjdxgczsbDao {
    ...
    public String queryCondition(String json, BuSpywSzgcqyrqjdxgczsbVO vo, Map map){
        ...
        try {
            ...
            String sql = "SELECT * FROM " + "BU_SPYW_SZGCQYRQJDXGCZSB t";

...
@Component
public class WxyDzgcDaoImpl  extends BsBaseDaoTJdbc implements WxyDzgcDao {
    ...
    public String queryCondition(String json, WxyDzgcVO vo, Map map){
        ...
        try {
            ...
            String sql = "SELECT * FROM " + "WXY_DZGC t";
    ...
    public boolean tuiHui(String gcId) {
        ...
        try {
            ...
            String sql = "update wxy_dzgc set status = 32 where gongcheng_uid = "+gcId;

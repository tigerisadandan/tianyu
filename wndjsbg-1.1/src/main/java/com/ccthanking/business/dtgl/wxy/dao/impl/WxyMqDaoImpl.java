...
@Component
public class WxyMqDaoImpl  extends BsBaseDaoTJdbc implements WxyMqDao {
    ...
    public String queryCondition(String json, WxyMqVO vo, Map map){
        ...
        try {
            ...
            String sql = "SELECT * FROM " + "WXY_MQ t";
    ...
    public boolean tuiHui(String gcId) {
        ...
        try {
            ...
            String sql = "update wxy_mq set status = 32 where gongcheng_uid = "+gcId;

...
@Component
public class BuSpywHjyxdjgzcns2DaoImpl  extends BsBaseDaoTJdbc implements BuSpywHjyxdjgzcns2Dao {
	private static Logger logger = LoggerFactory.getLogger(BuSpywHjyxdjgzcns2DaoImpl.class);
	private  String SQL_QUERY="select hjyxdjgzcns_uid, ywlz_uid, xmmc, jsdw, tbrq_date, frdb," +
			...
			" jsgm, scgm, qtqk, nkgrq, jhjsq, cqcs, tqsm from bu_spyw_hjyxdjgzcns2";
    public String queryCondition(String json){
        ...
        try {
            ...
            logger.error("环境影响登记告知承诺书信息表附件三查询失败!");
    ...
    public String queryReadFile(String id) throws Exception {
        ...
        String ListMX="select file_save_name,at_fileupload_uid from at_fileupload where target_uid="+id+" and file_type=39 and business_sub_type='BU_SPYW_HJYXDJGZCNS2'";
    	String filePath="";
    	String fileName="";
    	String uid="";
    	try {
	...
	public String insert(String json,Map files) throws Exception {
        ...
        vo.setHjyxdjgzcns_uid(DBUtil.getSequenceValue("HJYXDJGZCNS2_UID"));
        ...
        conn.commit();
        	...
        	DBUtil.rollbackConnetion(conn);
            e.printStackTrace(System.out);
            logger.error("环境影响登记告知承诺书信息表附件三新增失败!");
        } finally {
            DBUtil.closeConnetion(conn);
        }
		return resultVO;
	...
	public String update(String json,Map files) throws Exception {
        ...
        try {
            ...
            DBUtil.rollbackConnetion(conn);
            e.printStackTrace(System.out);
            logger.error("环境影响登记告知承诺书信息表附件三更改失败!");
        } finally {
            DBUtil.closeConnetion(conn);
        }
		return null;

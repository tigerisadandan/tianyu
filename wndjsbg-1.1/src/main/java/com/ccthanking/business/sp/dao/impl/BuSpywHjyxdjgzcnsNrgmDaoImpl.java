...
@Component
public class BuSpywHjyxdjgzcnsNrgmDaoImpl  extends BsBaseDaoTJdbc implements BuSpywHjyxdjgzcnsNrgmDao {
	private static Logger logger = LoggerFactory.getLogger(BuSpywHjyxdjgzcnsNrgmDaoImpl.class);
	private static String SQL_QUERY="select hjyxdjgzcnsnrgm_uid, hjyxdjgzcns_uid,   zycp_mc, zycp_sl," +
			" zyyfcl_mc, zyyfcl_sl from bu_spyw_hjyxdjgzcns_nrgm";
	
	
	public List<Map<String, String>> find(String id) throws Exception{
		
		Connection conn = DBUtil.getConnection();
        String ListMX="select hjyxdjgzcnsnrgm_uid, zycp_mc, zycp_sl,zyyfcl_mc, zyyfcl_sl  FROM BU_SPYW_HJYXDJGZCNS_NRGM where HJYXDJGZCNS_UID="+id+"order by HJYXDJGZCNS_UID desc";

/* ==================================================================
 * 版权：   kcit 版权所有 (c) 2013
 * 文件：   com.ccthanking.business.sp.BuSpywHjyxdjgzcns3Dao.java
...
/**
 * <p> BuSpywHjyxdjgzcns3Dao.java </p>
 * <p> 功能：环境影响登记告知承诺附件四 </p>
 *
 * <p><a href="BuSpywHjyxdjgzcns3Dao.java.html"><i>查看源代码</i></a></p>  
 *
...
@Component
public class BuSpywHjyxdjgzcns3DaoImpl  extends BsBaseDaoTJdbc implements BuSpywHjyxdjgzcns3Dao {
	private static Logger logger = LoggerFactory.getLogger(BuSpywHjyxdjgzcns3DaoImpl.class);
	private  String SQL_QUERY="select hjyxdjgzcns_uid, ywlz_uid, xmmc, jsdw, tbrq_date, frdb," +
			...
			" psqk, fzwrcsjs from bu_spyw_hjyxdjgzcns3";
    public String queryCondition(String json){
        ...
        try {
            ...
            logger.error("环境影响登记告知承诺书信息表附件四信息查询失败!");
    ...
    public String queryReadFile(String id) throws Exception {
        ...
        String ListMX="select file_save_name,at_fileupload_uid from at_fileupload where target_uid="+id+" and file_type=39 and business_sub_type='BU_SPYW_HJYXDJGZCNS3'";
    	String filePath="";
    	String fileName="";
    	String uid="";
    	try {
	...
	public String insert(String json,Map files) throws Exception {
        ...
        vo.setHjyxdjgzcns_uid(DBUtil.getSequenceValue("HJYXDJGZCNS3_UID"));
        ...
        conn.commit();
        	...
        	DBUtil.rollbackConnetion(conn);
            e.printStackTrace(System.out);
            logger.error("环境影响登记告知承诺书信息表附件四新增失败!");
        } finally {
            DBUtil.closeConnetion(conn);
        }
		return resultVO;
	...
	public String update(String json,Map files) throws Exception {
        ...
        try {
            ...
            DBUtil.rollbackConnetion(conn);
            e.printStackTrace(System.out);
            logger.error("环境影响登记告知承诺书信息表附件四更改失败!");
        } finally {
            DBUtil.closeConnetion(conn);
        }
		return null;

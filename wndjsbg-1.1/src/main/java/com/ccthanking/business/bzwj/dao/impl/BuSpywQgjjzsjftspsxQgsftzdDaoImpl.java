...
@Component
public class BuSpywQgjjzsjftspsxQgsftzdDaoImpl  extends BsBaseDaoTJdbc implements BuSpywQgjjzsjftspsxQgsftzdDao {
    ...
    public String queryCondition(String json, BuSpywQgjjzsjftspsxQgsftzdVO vo, Map map){
        ...
        try {
            ...
            String sql = "SELECT * FROM " + "BU_SPYW_QGJJZSJFTSPSX_QGSFTZD t";
    ...
    public String getCount() {
        ...
        String sql="";
        	...
        	sql="select count(*) from BU_SPYW_QGJJZSJFTSPSX_QGSFTZD ";
 ...
 public List<Map<String, String>> queryTpfFileNameByScxmid(String id){
        ...
        try {
            ...
            String sql = "select * from bu_sp_bzwj a where a.bzwj_uid=(select b.bzwj_uid from bu_sp_ywlz_bzwj b where " +
            		"b.lzbz_wj_uid=(select c.lzbz_wj_uid from BU_SPYW_QGJJZSJFTSPSX_QGSFTZD c where c.QGJJZSJFTSPSX_QGSFTZD_UID='"+id+"'))";
...
public String queryByLzbz(String lzbzId){
        ...
        try {
            ...
            String sql = "select a.*,(select c.opturl from bu_sp_bzwj c where c.bzwj_uid in(b.bzwj_uid)) as url" +
            		...
            		"from BU_SPYW_QGJJZSJFTSPSX_QGSFTZD a left join bu_sp_ywlz_bzwj b on  a.lzbz_wj_uid in b.LZBZ_WJ_UID where b.lzbz_uid='"+lzbzId+"'";

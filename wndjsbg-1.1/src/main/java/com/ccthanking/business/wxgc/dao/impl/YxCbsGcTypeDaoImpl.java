...
@Component
public class YxCbsGcTypeDaoImpl  extends BsBaseDaoTJdbc implements YxCbsGcTypeDao {
    ...
    public String queryCondition(String json, YxCbsGcTypeVO vo, Map map){
        ...
        try {
            ...
            String sql = "SELECT t.*,(select y.gc_type_name from yx_gc_type y where y.gc_type_code=t.gc_type_code) as gc_type_name" +
            		" FROM YX_CBS_GC_TYPE t";
            ...
            // 设置查询条件
             bs.setFieldDateFormat("GSRQ", "yyyy-MM-dd HH:mm");// 计量月份
